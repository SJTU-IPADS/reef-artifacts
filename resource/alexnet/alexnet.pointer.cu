...
__device__ __noinline__ void fused_nn_max_pool2d_kernel0_device(float* __restrict__ placeholder, float* __restrict__ tensor){
...
__device__ __noinline__ void fused_nn_conv2d_nn_relu_3_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu){
  float compute[2];
...
__device__ __noinline__ void fused_nn_conv2d_nn_relu_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu){
  float compute[1];
...
__device__ __noinline__ void fused_nn_max_pool2d_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ tensor){
  float tensor_local[1];
  tensor_local[(0)] = -3.402823e+38f;
  for (int dh = 0; dh < 3; ++dh) {
    for (int dw = 0; dw < 3; ++dw) {
...
__device__ __noinline__ void fused_nn_dense_add_nn_relu_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float T_dense_rf[1];
  float red_buf0[1];
  __shared__ float T_dense[1];
  T_dense_rf[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_conv2d_nn_relu_4_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu){
  float compute[1];
...
__device__ __noinline__ void fused_nn_max_pool2d_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ tensor){
  float tensor_local[1];
  tensor_local[(0)] = -3.402823e+38f;
  for (int dh = 0; dh < 3; ++dh) {
    for (int dw = 0; dw < 3; ++dw) {
...
__device__ __noinline__ void fused_nn_conv2d_nn_relu_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu){
  float compute[1];
  __shared__ float pad_temp_shared[192];
  __shared__ float placeholder_shared[2304];
  compute[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_conv2d_nn_relu_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu){
  float compute[1];
  __shared__ float pad_temp_shared[192];
  __shared__ float placeholder_shared[2304];
  compute[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_dense_add_nn_relu_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float T_dense_rf[1];
  float red_buf0[1];
  __shared__ float T_dense[1];
  T_dense_rf[(0)] = 0.000000e+00f;
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_max_pool2d_kernel0(float* __restrict__ placeholder, float* __restrict__ tensor) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_nn_relu_3_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu) {
    fused_nn_conv2d_nn_relu_3_kernel0_device(placeholder, placeholder1, T_relu);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_nn_relu_1_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_max_pool2d_2_kernel0(float* __restrict__ placeholder, float* __restrict__ tensor) {
    fused_nn_max_pool2d_2_kernel0_device(placeholder, tensor);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_dense_add_nn_relu_1_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    fused_nn_dense_add_nn_relu_1_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_nn_relu_4_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu) {
    fused_nn_conv2d_nn_relu_4_kernel0_device(placeholder, placeholder1, T_relu);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_max_pool2d_1_kernel0(float* __restrict__ placeholder, float* __restrict__ tensor) {
    fused_nn_max_pool2d_1_kernel0_device(placeholder, tensor);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_nn_relu_2_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_nn_relu_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu) {
    fused_nn_conv2d_nn_relu_kernel0_device(placeholder, placeholder1, T_relu);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_dense_add_nn_relu_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
...
extern "C" __global__ void _get_func_pointers(unsigned long long int *address) {
    ...
    address[1] = (unsigned long long int)&fused_nn_conv2d_nn_relu_1_kernel0_device;
    address[2] = (unsigned long long int)&fused_nn_conv2d_nn_relu_2_kernel0_device;
    address[3] = (unsigned long long int)&fused_nn_conv2d_nn_relu_3_kernel0_device;
    address[4] = (unsigned long long int)&fused_nn_conv2d_nn_relu_4_kernel0_device;
    address[5] = (unsigned long long int)&fused_nn_conv2d_nn_relu_kernel0_device;
    address[6] = (unsigned long long int)&fused_nn_dense_add_kernel0_device;
    address[7] = (unsigned long long int)&fused_nn_dense_add_nn_relu_1_kernel0_device;
    address[8] = (unsigned long long int)&fused_nn_dense_add_nn_relu_kernel0_device;
    address[9] = (unsigned long long int)&fused_nn_max_pool2d_1_kernel0_device;
    address[10] = (unsigned long long int)&fused_nn_max_pool2d_2_kernel0_device;
    address[11] = (unsigned long long int)&fused_nn_max_pool2d_kernel0_device;
    address[12] = (unsigned long long int)&fused_nn_softmax_kernel0_device;
