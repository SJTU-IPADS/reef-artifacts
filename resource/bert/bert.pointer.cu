...
__device__ __noinline__ void fused_nn_softmax_1_kernel0_device(float* __restrict__ T_softmax_maxelem, float* __restrict__ placeholder){
...
__device__ __noinline__ void fused_reshape_add_add_kernel0_device(float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ placeholder2){
...
__device__ __noinline__ void fused_nn_batch_matmul_4_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
...
__device__ __noinline__ void fused_nn_batch_matmul_5_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
...
__device__ __noinline__ void fused_nn_softmax_1_kernel1_device(float* __restrict__ T_softmax_exp, float* __restrict__ placeholder, float* __restrict__ T_softmax_maxelem){
...
__device__ __noinline__ void fused_reshape_add_multiply_erf_multiply_add_multiply_reshape_kernel0_device(float* __restrict__ T_reshape, float* __restrict__ placeholder, float* __restrict__ placeholder1){
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
...
__device__ __noinline__ void fused_mean_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder_red){
...
__device__ __noinline__ void fused_subtract_add_sqrt_divide_multiply_add_1_kernel0_device(float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ placeholder2, float* __restrict__ placeholder3, float* __restrict__ placeholder4){
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
...
__device__ __noinline__ void fused_nn_batch_matmul_3_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
...
__device__ __noinline__ void fused_reshape_5_kernel0_device(float* __restrict__ T_reshape, float* __restrict__ placeholder){
...
__device__ __noinline__ void fused_reshape_transpose_copy_reshape_1_kernel0_device(float* __restrict__ T_reshape, float* __restrict__ placeholder){
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
...
__device__ __noinline__ void fused_reshape_add_reshape_transpose_reshape_transpose_kernel0_device(float* __restrict__ T_transpose, float* __restrict__ placeholder, float* __restrict__ placeholder1){
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
...
__device__ __noinline__ void fused_reshape_add_reshape_transpose_transpose_reshape_transpose_kernel0_device(float* __restrict__ T_transpose, float* __restrict__ placeholder, float* __restrict__ placeholder1){
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
...
__device__ __noinline__ void fused_reshape_add_reshape_transpose_divide_reshape_kernel0_device(float* __restrict__ T_reshape, float* __restrict__ placeholder, float* __restrict__ placeholder1){
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
...
__device__ __noinline__ void fused_full_equal_reshape_kernel0_device(signed char* __restrict__ T_reshape){
  if (((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < 480) {
    T_reshape[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)))] = (signed char)0;
  }
}

__device__ __noinline__ void fused_cast_take_broadcast_to_like_cast_take_add_1_kernel0_device(float* __restrict__ T_add, float* __restrict__ placeholder, long* __restrict__ placeholder1, float* __restrict__ placeholder2, long* __restrict__ placeholder3){
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
...
__device__ __noinline__ void fused_nn_softmax_1_kernel2_device(float* __restrict__ T_softmax_maxelem, float* __restrict__ T_softmax_exp){
  if (((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < 5760) {
...
__device__ __noinline__ void fused_mean_1_kernel1_device(float* __restrict__ T_divide, float* __restrict__ placeholder_red){
  if (((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < 480) {
    T_divide[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)))] = (placeholder_red[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)))] * 2.083333e-03f);
  }
}

__device__ __noinline__ void fused_reshape_4_kernel0_device(float* __restrict__ T_reshape, float* __restrict__ placeholder){
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
      T_reshape[((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)))] = placeholder[((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)))];
    }
...
__device__ __noinline__ void fused_variance_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_multiply_red){
...
__device__ __noinline__ void fused_variance_1_kernel1_device(float* __restrict__ T_divide, float* __restrict__ T_multiply_red){
  if (((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < 480) {
    T_divide[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)))] = (T_multiply_red[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)))] * 2.083333e-03f);
  }
}

__device__ __noinline__ void fused_reshape_cast_broadcast_to_like_where_kernel0_device(float* __restrict__ T_where, signed char* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__ __noinline__ void fused_nn_softmax_1_kernel3_device(float* __restrict__ T_softmax_norm, float* __restrict__ T_softmax_exp, float* __restrict__ T_softmax_maxelem){
  for (int i0_i1_fused_i2_fused_i3_fused_outer = 0; i0_i1_fused_i2_fused_i3_fused_outer < 43; ++i0_i1_fused_i2_fused_i3_fused_outer) {
    if ((((i0_i1_fused_i2_fused_i3_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 2764800) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_softmax_1_kernel0(float* __restrict__ T_softmax_maxelem, float* __restrict__ placeholder) {
    fused_nn_softmax_1_kernel0_device(T_softmax_maxelem, placeholder);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_reshape_add_add_kernel0(float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ placeholder2) {
    fused_reshape_add_add_kernel0_device(T_add, placeholder, placeholder1, placeholder2);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_batch_matmul_4_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    fused_nn_batch_matmul_4_kernel0_device(placeholder, placeholder1, compute);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_batch_matmul_5_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    fused_nn_batch_matmul_5_kernel0_device(placeholder, placeholder1, compute);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_softmax_1_kernel1(float* __restrict__ T_softmax_exp, float* __restrict__ placeholder, float* __restrict__ T_softmax_maxelem) {
    fused_nn_softmax_1_kernel1_device(T_softmax_exp, placeholder, T_softmax_maxelem);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_reshape_add_multiply_erf_multiply_add_multiply_reshape_kernel0(float* __restrict__ T_reshape, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    fused_reshape_add_multiply_erf_multiply_add_multiply_reshape_kernel0_device(T_reshape, placeholder, placeholder1);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_mean_1_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder_red) {
    fused_mean_1_kernel0_device(placeholder, placeholder_red);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_subtract_add_sqrt_divide_multiply_add_1_kernel0(float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ placeholder2, float* __restrict__ placeholder3, float* __restrict__ placeholder4) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_batch_matmul_3_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    fused_nn_batch_matmul_3_kernel0_device(placeholder, placeholder1, compute);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_reshape_5_kernel0(float* __restrict__ T_reshape, float* __restrict__ placeholder) {
    fused_reshape_5_kernel0_device(T_reshape, placeholder);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_reshape_transpose_copy_reshape_1_kernel0(float* __restrict__ T_reshape, float* __restrict__ placeholder) {
    fused_reshape_transpose_copy_reshape_1_kernel0_device(T_reshape, placeholder);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_reshape_add_reshape_transpose_reshape_transpose_kernel0(float* __restrict__ T_transpose, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    fused_reshape_add_reshape_transpose_reshape_transpose_kernel0_device(T_transpose, placeholder, placeholder1);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_reshape_add_reshape_transpose_transpose_reshape_transpose_kernel0(float* __restrict__ T_transpose, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    fused_reshape_add_reshape_transpose_transpose_reshape_transpose_kernel0_device(T_transpose, placeholder, placeholder1);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_reshape_add_reshape_transpose_divide_reshape_kernel0(float* __restrict__ T_reshape, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    fused_reshape_add_reshape_transpose_divide_reshape_kernel0_device(T_reshape, placeholder, placeholder1);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_full_equal_reshape_kernel0(signed char* __restrict__ T_reshape) {
    fused_full_equal_reshape_kernel0_device(T_reshape);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_cast_take_broadcast_to_like_cast_take_add_1_kernel0(float* __restrict__ T_add, float* __restrict__ placeholder, long* __restrict__ placeholder1, float* __restrict__ placeholder2, long* __restrict__ placeholder3) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_softmax_1_kernel2(float* __restrict__ T_softmax_maxelem, float* __restrict__ T_softmax_exp) {
    fused_nn_softmax_1_kernel2_device(T_softmax_maxelem, T_softmax_exp);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_mean_1_kernel1(float* __restrict__ T_divide, float* __restrict__ placeholder_red) {
    fused_mean_1_kernel1_device(T_divide, placeholder_red);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_reshape_4_kernel0(float* __restrict__ T_reshape, float* __restrict__ placeholder) {
    fused_reshape_4_kernel0_device(T_reshape, placeholder);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_variance_1_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_multiply_red) {
    fused_variance_1_kernel0_device(placeholder, placeholder1, T_multiply_red);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_variance_1_kernel1(float* __restrict__ T_divide, float* __restrict__ T_multiply_red) {
    fused_variance_1_kernel1_device(T_divide, T_multiply_red);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_reshape_cast_broadcast_to_like_where_kernel0(float* __restrict__ T_where, signed char* __restrict__ placeholder, float* __restrict__ placeholder1) {
    fused_reshape_cast_broadcast_to_like_where_kernel0_device(T_where, placeholder, placeholder1);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_softmax_1_kernel3(float* __restrict__ T_softmax_norm, float* __restrict__ T_softmax_exp, float* __restrict__ T_softmax_maxelem) {
...
extern "C" __global__ void _get_func_pointers(unsigned long long int *address) {
    address[0] = (unsigned long long int)&fused_cast_take_broadcast_to_like_cast_take_add_1_kernel0_device;
    address[1] = (unsigned long long int)&fused_full_equal_reshape_kernel0_device;
    address[2] = (unsigned long long int)&fused_mean_1_kernel0_device;
    address[3] = (unsigned long long int)&fused_mean_1_kernel1_device;
    address[4] = (unsigned long long int)&fused_nn_batch_matmul_3_kernel0_device;
    address[5] = (unsigned long long int)&fused_nn_batch_matmul_4_kernel0_device;
    address[6] = (unsigned long long int)&fused_nn_batch_matmul_5_kernel0_device;
    address[7] = (unsigned long long int)&fused_nn_softmax_1_kernel0_device;
    address[8] = (unsigned long long int)&fused_nn_softmax_1_kernel1_device;
    address[9] = (unsigned long long int)&fused_nn_softmax_1_kernel2_device;
    address[10] = (unsigned long long int)&fused_nn_softmax_1_kernel3_device;
    address[11] = (unsigned long long int)&fused_reshape_4_kernel0_device;
    address[12] = (unsigned long long int)&fused_reshape_5_kernel0_device;
    address[13] = (unsigned long long int)&fused_reshape_add_add_kernel0_device;
    address[14] = (unsigned long long int)&fused_reshape_add_multiply_erf_multiply_add_multiply_reshape_kernel0_device;
    address[15] = (unsigned long long int)&fused_reshape_add_reshape_transpose_divide_reshape_kernel0_device;
    address[16] = (unsigned long long int)&fused_reshape_add_reshape_transpose_reshape_transpose_kernel0_device;
    address[17] = (unsigned long long int)&fused_reshape_add_reshape_transpose_transpose_reshape_transpose_kernel0_device;
    address[18] = (unsigned long long int)&fused_reshape_cast_broadcast_to_like_where_kernel0_device;
    address[19] = (unsigned long long int)&fused_reshape_transpose_copy_reshape_1_kernel0_device;
    address[20] = (unsigned long long int)&fused_subtract_add_sqrt_divide_multiply_add_1_kernel0_device;
    address[21] = (unsigned long long int)&fused_variance_1_kernel0_device;
    address[22] = (unsigned long long int)&fused_variance_1_kernel1_device;
