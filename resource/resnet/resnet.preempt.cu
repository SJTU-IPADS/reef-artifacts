...
__device__  void fused_add_nn_relu_1_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
  for (int ax0_ax1_fused_ax2_fused_ax3_fused_outer = 0; ax0_ax1_fused_ax2_fused_ax3_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_ax3_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer * 65536) + (((int)task_idx.x) * 256)) + ((int)threadIdx.x)) < 200704) {
      T_relu[((((ax0_ax1_fused_ax2_fused_ax3_fused_outer * 65536) + (((int)task_idx.x) * 256)) + ((int)threadIdx.x)))] = max((placeholder[((((ax0_ax1_fused_ax2_fused_ax3_fused_outer * 65536) + (((int)task_idx.x) * 256)) + ((int)threadIdx.x)))] + placeholder1[(((((ax0_ax1_fused_ax2_fused_ax3_fused_outer * 65536) + (((int)task_idx.x) * 256)) + ((int)threadIdx.x)) / 196))]), 0.000000e+00f);
    }
  }
}
  ...
  for (int rv0 = 0; rv0 < 7; ++rv0) {
    for (int rv1 = 0; rv1 < 7; ++rv1) {
      if (((int)threadIdx.y) < 1) {
        tensor1[(0)] = (tensor1[(0)] + placeholder[((((((((int)threadIdx.y) * 100352) + (((int)task_idx.x) * 392)) + (((int)threadIdx.x) * 49)) + (rv0 * 7)) + rv1))]);
      }
    }
  }
  if (((int)threadIdx.y) < 1) {
    tensor[((((((int)threadIdx.y) * 2048) + (((int)task_idx.x) * 8)) + ((int)threadIdx.x)))] = (tensor1[(0)] * 2.040816e-02f);
  }
}
...
__device__  void fused_nn_conv2d_add_nn_relu_7_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  T_relu[(((((((((int)task_idx.z) * 100352) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)))] = max((compute[(0)] + placeholder2[(((((int)task_idx.z) * 32) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 100352) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50176))] = max((compute[(2)] + placeholder2[((((((int)task_idx.z) * 32) + ((int)threadIdx.z)) + 16))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 100352) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = max((compute[(1)] + placeholder2[(((((int)task_idx.z) * 32) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 100352) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50177))] = max((compute[(3)] + placeholder2[((((((int)task_idx.z) * 32) + ((int)threadIdx.z)) + 16))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_3_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  ...
  for (int rc_outer = 0; rc_outer < 4; ++rc_outer) {
    __syncthreads();
    pad_temp_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)))] = placeholder[(((((((rc_outer * 50176) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)))];
    pad_temp_shared[(((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder[((((((((rc_outer * 50176) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 1))];
  ...
  T_add[(((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)))] = (compute[(0)] + placeholder2[(((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)))]);
  T_add[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50176))] = (compute[(2)] + placeholder2[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50176))]);
  T_add[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100352))] = (compute[(4)] + placeholder2[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100352))]);
  T_add[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 150528))] = (compute[(6)] + placeholder2[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 150528))]);
  T_add[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = (compute[(1)] + placeholder2[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 1))]);
  T_add[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50177))] = (compute[(3)] + placeholder2[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50177))]);
  T_add[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100353))] = (compute[(5)] + placeholder2[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100353))]);
  T_add[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 150529))] = (compute[(7)] + placeholder2[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 150529))]);
}
...
__device__  void fused_nn_conv2d_add_add_nn_relu_1_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3){
  ...
  for (int rc_outer = 0; rc_outer < 16; ++rc_outer) {
    ...
    for (int ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner = 0; ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner < 2; ++ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) {
      pad_temp_shared[(((((((int)threadIdx.z) * 112) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner))] = placeholder[(((((((rc_outer * 6272) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner))];
    }
      ...
      if ((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 8)) + ((int)threadIdx.x)) < 256) {
        if (((((int)threadIdx.y) * 8) + ((int)threadIdx.x)) < 32) {
          if (((int)threadIdx.x) < 8) {
            placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 8)) + ((int)threadIdx.x)))] = placeholder1[((((((((int)task_idx.z) * 4096) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 128)) + (rc_outer * 8)) + ((int)threadIdx.x)))];
          }
        }
      }
    }
  ...
  for (int ax3_inner_inner_inner = 0; ax3_inner_inner_inner < 2; ++ax3_inner_inner_inner) {
    T_relu[(((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner))] = max(((compute[(ax3_inner_inner_inner)] + placeholder2[(((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner))]) + placeholder3[(((((int)task_idx.z) * 32) + ((int)threadIdx.z)))]), 0.000000e+00f);
    T_relu[((((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner) + 6272))] = max(((compute[((ax3_inner_inner_inner + 2))] + placeholder2[((((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner) + 6272))]) + placeholder3[((((((int)task_idx.z) * 32) + ((int)threadIdx.z)) + 8))]), 0.000000e+00f);
    T_relu[((((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner) + 12544))] = max(((compute[((ax3_inner_inner_inner + 4))] + placeholder2[((((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner) + 12544))]) + placeholder3[((((((int)task_idx.z) * 32) + ((int)threadIdx.z)) + 16))]), 0.000000e+00f);
    T_relu[((((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner) + 18816))] = max(((compute[((ax3_inner_inner_inner + 6))] + placeholder2[((((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner) + 18816))]) + placeholder3[((((((int)task_idx.z) * 32) + ((int)threadIdx.z)) + 24))]), 0.000000e+00f);
  }
}
...
__device__  void fused_nn_conv2d_add_nn_relu_4_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  for (int rc_outer = 0; rc_outer < 32; ++rc_outer) {
    __syncthreads();
    pad_temp_shared[((((((int)threadIdx.z) * 56) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)))] = placeholder[((((((rc_outer * 12544) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 56)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)))];
    pad_temp_shared[(((((((int)threadIdx.z) * 56) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder[(((((((rc_outer * 12544) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 56)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + 1))];
    if (((((((int)threadIdx.y) * 8) + ((int)threadIdx.x)) >> 4) + ((int)threadIdx.z)) < 16) {
      if ((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + ((int)threadIdx.x)) < 256) {
        if (((((int)threadIdx.y) * 8) + ((int)threadIdx.x)) < 16) {
          if (((int)threadIdx.x) < 8) {
            placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + ((int)threadIdx.x)))] = placeholder1[((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 512)) + (rc_outer * 16)) + (((int)threadIdx.y) * 8)) + ((int)threadIdx.x)))];
          }
        }
      }
    }
  ...
  T_relu[((((((((int)task_idx.z) * 12544) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 56)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)))] = max((compute[(0)] + placeholder2[(((((int)task_idx.z) * 16) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[(((((((((int)task_idx.z) * 12544) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 56)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + 1))] = max((compute[(1)] + placeholder2[(((((int)task_idx.z) * 16) + ((int)threadIdx.z)))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_2_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  ...
  for (int ax3_inner_inner_inner = 0; ax3_inner_inner_inner < 2; ++ax3_inner_inner_inner) {
    T_add[(((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner))] = (compute[(ax3_inner_inner_inner)] + placeholder2[(((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner))]);
    T_add[((((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner) + 6272))] = (compute[((ax3_inner_inner_inner + 2))] + placeholder2[((((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner) + 6272))]);
    T_add[((((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner) + 12544))] = (compute[((ax3_inner_inner_inner + 4))] + placeholder2[((((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner) + 12544))]);
    T_add[((((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner) + 18816))] = (compute[((ax3_inner_inner_inner + 6))] + placeholder2[((((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + ax3_inner_inner_inner) + 18816))]);
  }
}
...
__device__  void fused_nn_conv2d_add_nn_relu_3_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
      ...
      if (((((((int)threadIdx.x) * 2) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) / 27) + ((int)threadIdx.z)) < 32) {
        if ((((((int)threadIdx.z) * 27) + (((int)threadIdx.x) * 2)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) < 864) {
          if (((((int)threadIdx.x) * 2) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) < 27) {
            pad_temp_shared[((((((int)threadIdx.z) * 27) + (((int)threadIdx.x) * 2)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner))] = placeholder[((((((rc_outer * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 56)) + (((int)threadIdx.x) * 2)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner))];
          }
        }
      }
    }
      ...
      if (((((((int)threadIdx.x) * 3) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1) >> 5) + ((int)threadIdx.z)) < 32) {
        if ((((((int)threadIdx.z) * 32) + (((int)threadIdx.x) * 3)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1) < 1024) {
          if (((((int)threadIdx.x) * 3) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1) < 32) {
            placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.x) * 3)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1))] = placeholder1[((((((((int)task_idx.z) * 16384) + (((int)threadIdx.z) * 512)) + (rc_outer * 32)) + (((int)threadIdx.x) * 3)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1))];
          }
        }
      }
    }
  ...
  T_relu[(((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 14)) + ((int)threadIdx.x)))] = max((compute[(0)] + placeholder2[(((((int)task_idx.z) * 32) + ((int)threadIdx.z)))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
      ...
      if ((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 5)) + ((int)threadIdx.x)) < 256) {
        if (((((int)threadIdx.y) * 5) + ((int)threadIdx.x)) < 32) {
          if (((int)threadIdx.x) < 5) {
            placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 5)) + ((int)threadIdx.x)))] = placeholder1[((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 1024)) + ((((((int)threadIdx.y) * 5) + ((int)threadIdx.x)) >> 4) * 512)) + (rc_outer * 16)) + (((((int)threadIdx.y) * 5) + ((int)threadIdx.x)) & 15)))];
          }
        }
      }
    }
  ...
  T_add[(((((((int)task_idx.z) * 784) + (((int)threadIdx.z) * 49)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))] = (compute[(0)] + placeholder2[(((((((int)task_idx.z) * 784) + (((int)threadIdx.z) * 49)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))]);
  T_add[((((((((int)task_idx.z) * 784) + (((int)threadIdx.z) * 49)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 392))] = (compute[(1)] + placeholder2[((((((((int)task_idx.z) * 784) + (((int)threadIdx.z) * 49)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 392))]);
}
...
__device__  void fused_nn_conv2d_add_nn_relu_1_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  for (int rc_outer = 0; rc_outer < 32; ++rc_outer) {
    __syncthreads();
    pad_temp_shared[(((((int)threadIdx.z) * 13) + (((int)threadIdx.x) * 2)))] = placeholder[(((((rc_outer * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 28)) + (((int)threadIdx.x) * 2)))];
    if (((((((int)threadIdx.x) * 2) + 1) / 13) + ((int)threadIdx.z)) < 32) {
      if (((((int)threadIdx.z) * 13) + (((int)threadIdx.x) * 2)) < 415) {
        if (((int)threadIdx.x) < 6) {
          pad_temp_shared[((((((int)threadIdx.z) * 13) + (((int)threadIdx.x) * 2)) + 1))] = placeholder[((((((rc_outer * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 28)) + (((int)threadIdx.x) * 2)) + 1))];
        }
      }
    }
    placeholder_shared[(((((int)threadIdx.z) * 32) + (((int)threadIdx.x) * 5)))] = placeholder1[(((((((int)task_idx.z) * 32768) + (((int)threadIdx.z) * 1024)) + (rc_outer * 32)) + (((int)threadIdx.x) * 5)))];
    placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.x) * 5)) + 1))] = placeholder1[((((((((int)task_idx.z) * 32768) + (((int)threadIdx.z) * 1024)) + (rc_outer * 32)) + (((int)threadIdx.x) * 5)) + 1))];
    if (((((((int)threadIdx.x) * 5) + 2) >> 5) + ((int)threadIdx.z)) < 32) {
      if (((((int)threadIdx.z) * 32) + (((int)threadIdx.x) * 5)) < 1022) {
        if (((int)threadIdx.x) < 6) {
          placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.x) * 5)) + 2))] = placeholder1[((((((((int)task_idx.z) * 32768) + (((int)threadIdx.z) * 1024)) + (rc_outer * 32)) + (((int)threadIdx.x) * 5)) + 2))];
        }
      }
    }
    if (((((((int)threadIdx.x) * 5) + 3) >> 5) + ((int)threadIdx.z)) < 32) {
      if (((((int)threadIdx.z) * 32) + (((int)threadIdx.x) * 5)) < 1021) {
        if (((int)threadIdx.x) < 6) {
          placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.x) * 5)) + 3))] = placeholder1[((((((((int)task_idx.z) * 32768) + (((int)threadIdx.z) * 1024)) + (rc_outer * 32)) + (((int)threadIdx.x) * 5)) + 3))];
        }
      }
    }
    if (((((((int)threadIdx.x) * 5) + 4) >> 5) + ((int)threadIdx.z)) < 32) {
      if (((((int)threadIdx.z) * 32) + (((int)threadIdx.x) * 5)) < 1020) {
        if (((int)threadIdx.x) < 6) {
          placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.x) * 5)) + 4))] = placeholder1[((((((((int)task_idx.z) * 32768) + (((int)threadIdx.z) * 1024)) + (rc_outer * 32)) + (((int)threadIdx.x) * 5)) + 4))];
        }
      }
    }
    __syncthreads();
...
__device__  void fused_add_nn_relu_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
  for (int ax0_ax1_fused_ax2_fused_ax3_fused_outer = 0; ax0_ax1_fused_ax2_fused_ax3_fused_outer < 2; ++ax0_ax1_fused_ax2_fused_ax3_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer * 65536) + (((int)task_idx.x) * 256)) + ((int)threadIdx.x)) < 100352) {
      T_relu[((((ax0_ax1_fused_ax2_fused_ax3_fused_outer * 65536) + (((int)task_idx.x) * 256)) + ((int)threadIdx.x)))] = max((placeholder[((((ax0_ax1_fused_ax2_fused_ax3_fused_outer * 65536) + (((int)task_idx.x) * 256)) + ((int)threadIdx.x)))] + placeholder1[(((((ax0_ax1_fused_ax2_fused_ax3_fused_outer * 65536) + (((int)task_idx.x) * 256)) + ((int)threadIdx.x)) / 49))]), 0.000000e+00f);
    }
  }
}
...
__device__  void fused_nn_conv2d_add_nn_relu_2_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  for (int rc_outer = 0; rc_outer < 64; ++rc_outer) {
    __syncthreads();
    pad_temp_shared[((((((int)threadIdx.z) * 28) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)))] = placeholder[((((((rc_outer * 3136) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 28)) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)))];
    if (((((((int)threadIdx.y) * 8) + ((int)threadIdx.x)) >> 4) + ((int)threadIdx.z)) < 16) {
      if ((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + ((int)threadIdx.x)) < 256) {
        if (((((int)threadIdx.y) * 8) + ((int)threadIdx.x)) < 16) {
          if (((int)threadIdx.x) < 8) {
            placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + ((int)threadIdx.x)))] = placeholder1[((((((((int)task_idx.z) * 16384) + (((int)threadIdx.z) * 1024)) + (rc_outer * 16)) + (((int)threadIdx.y) * 8)) + ((int)threadIdx.x)))];
          }
        }
      }
    }
  ...
  T_relu[((((((((int)task_idx.z) * 3136) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 28)) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)))] = max((compute[(0)] + placeholder2[(((((int)task_idx.z) * 16) + ((int)threadIdx.z)))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_add_nn_relu_2_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3){
  ...
  T_relu[(((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)))] = max(((compute[(0)] + placeholder2[(((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)))]) + placeholder3[(((((int)task_idx.z) * 64) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50176))] = max(((compute[(2)] + placeholder2[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50176))]) + placeholder3[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 16))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100352))] = max(((compute[(4)] + placeholder2[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100352))]) + placeholder3[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 32))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 150528))] = max(((compute[(6)] + placeholder2[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 150528))]) + placeholder3[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 48))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = max(((compute[(1)] + placeholder2[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 1))]) + placeholder3[(((((int)task_idx.z) * 64) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50177))] = max(((compute[(3)] + placeholder2[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50177))]) + placeholder3[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 16))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100353))] = max(((compute[(5)] + placeholder2[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100353))]) + placeholder3[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 32))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 150529))] = max(((compute[(7)] + placeholder2[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 150529))]) + placeholder3[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 48))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_2_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
  ...
  for (int rc_outer = 0; rc_outer < 32; ++rc_outer) {
    ...
    if ((((((int)threadIdx.z) * 21) + (((int)threadIdx.y) * 11)) + (((int)threadIdx.x) * 2)) < 1296) {
      if (((((int)threadIdx.y) * 11) + (((int)threadIdx.x) * 2)) < 21) {
        if (((int)threadIdx.x) < 6) {
          pad_temp_shared[((((((int)threadIdx.z) * 21) + (((int)threadIdx.y) * 11)) + (((int)threadIdx.x) * 2)))] = placeholder[((((((rc_outer * 12544) + (((((((int)threadIdx.z) * 21) + (((int)threadIdx.y) * 11)) + (((int)threadIdx.x) * 2)) / 81) * 784)) + (((int)task_idx.y) * 112)) + ((((((((int)threadIdx.z) * 21) + (((int)threadIdx.y) * 11)) + (((int)threadIdx.x) * 2)) % 81) / 27) * 28)) + ((((((int)threadIdx.z) * 21) + (((int)threadIdx.y) * 11)) + (((int)threadIdx.x) * 2)) % 27)))];
        }
      }
    }
    if ((((((int)threadIdx.z) * 21) + (((int)threadIdx.y) * 11)) + (((int)threadIdx.x) * 2)) < 1295) {
      if (((((int)threadIdx.y) * 11) + (((int)threadIdx.x) * 2)) < 20) {
        if (((int)threadIdx.x) < 5) {
          pad_temp_shared[(((((((int)threadIdx.z) * 21) + (((int)threadIdx.y) * 11)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder[((((((rc_outer * 12544) + ((((((((int)threadIdx.z) * 21) + (((int)threadIdx.y) * 11)) + (((int)threadIdx.x) * 2)) + 1) / 81) * 784)) + (((int)task_idx.y) * 112)) + (((((((((int)threadIdx.z) * 21) + (((int)threadIdx.y) * 11)) + (((int)threadIdx.x) * 2)) + 1) % 81) / 27) * 28)) + (((((((int)threadIdx.z) * 21) + (((int)threadIdx.y) * 11)) + (((int)threadIdx.x) * 2)) + 1) % 27)))];
        }
      }
    }
      ...
      if ((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) < 1024) {
        if (((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)) < 16) {
          if (((int)threadIdx.x) < 4) {
            placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)))] = placeholder1[((((((((int)task_idx.z) * 32768) + (((int)threadIdx.z) * 512)) + (rc_outer * 16)) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)))];
          }
        }
      }
    }
    if ((((((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)) + 1) >> 4) + ((int)threadIdx.z)) < 64) {
      if ((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) < 1023) {
        if (((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)) < 15) {
          if (((int)threadIdx.x) < 4) {
            placeholder_shared[(((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder1[(((((((((int)task_idx.z) * 32768) + (((int)threadIdx.z) * 512)) + (rc_outer * 16)) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + 1))];
          }
        }
      }
    }
  ...
  compute[((((((((int)task_idx.z) * 12544) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 28)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)))] = compute_local[(0)];
  compute[(((((((((int)task_idx.z) * 12544) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 28)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 1))] = compute_local[(1)];
}
...
__device__  void fused_nn_conv2d_add_add_nn_relu_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3){
  ...
  for (int rc_outer = 0; rc_outer < 16; ++rc_outer) {
    __syncthreads();
    pad_temp_shared[((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)))] = placeholder[((((((rc_outer * 3136) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)))];
    pad_temp_shared[(((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder[(((((((rc_outer * 3136) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 1))];
    if (((((int)threadIdx.z) * 2) + (((((int)threadIdx.y) * 5) + ((int)threadIdx.x)) >> 4)) < 32) {
      if ((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 5)) + ((int)threadIdx.x)) < 512) {
        if (((((int)threadIdx.y) * 5) + ((int)threadIdx.x)) < 32) {
          if (((int)threadIdx.x) < 5) {
            placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 5)) + ((int)threadIdx.x)))] = placeholder1[((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 512)) + ((((((int)threadIdx.y) * 5) + ((int)threadIdx.x)) >> 4) * 256)) + (rc_outer * 16)) + (((((int)threadIdx.y) * 5) + ((int)threadIdx.x)) & 15)))];
          }
        }
      }
    }
  ...
  T_relu[((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)))] = max(((compute[(0)] + placeholder2[((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)))]) + placeholder3[(((((int)task_idx.z) * 32) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[(((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 3136))] = max(((compute[(2)] + placeholder2[(((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 3136))]) + placeholder3[((((((int)task_idx.z) * 32) + ((int)threadIdx.z)) + 16))]), 0.000000e+00f);
  T_relu[(((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 1))] = max(((compute[(1)] + placeholder2[(((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 1))]) + placeholder3[(((((int)task_idx.z) * 32) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[(((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 3137))] = max(((compute[(3)] + placeholder2[(((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 3137))]) + placeholder3[((((((int)task_idx.z) * 32) + ((int)threadIdx.z)) + 16))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_nn_relu_6_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  for (int rc_outer = 0; rc_outer < 16; ++rc_outer) {
    ...
    pad_temp_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)))] = placeholder[(((((((rc_outer * 50176) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)))];
    pad_temp_shared[(((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder[((((((((rc_outer * 50176) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 1))];
    placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)))] = placeholder1[((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 256)) + (rc_outer * 16)) + (((int)threadIdx.x) * 4)))];
    placeholder_shared[(((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 256)) + (rc_outer * 16)) + (((int)threadIdx.x) * 4)) + 1))];
    placeholder_shared[(((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 256)) + (rc_outer * 16)) + (((int)threadIdx.x) * 4)) + 2))];
    placeholder_shared[(((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 256)) + (rc_outer * 16)) + (((int)threadIdx.x) * 4)) + 3))];
    __syncthreads();
    compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
    compute[(2)] = __ocml_fma_f32(pad_temp_shared[(((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)))], placeholder_shared[(((((int)threadIdx.z) * 16) + 256))], compute[(2)]);
    compute[(1)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)) + 1))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(1)]);
...
__device__  void fused_nn_conv2d_1_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
  ...
  for (int rc_outer = 0; rc_outer < 32; ++rc_outer) {
    ...
    if ((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)) < 1320) {
      pad_temp_shared[((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)))] = placeholder[((((((rc_outer * 25088) + (((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)) / 165) * 3136)) + (((int)task_idx.y) * 224)) + ((((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)) % 165) / 55) * 56)) + ((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)) % 55)))];
    }
    if ((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)) < 1319) {
      pad_temp_shared[(((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)) + 1))] = placeholder[((((((rc_outer * 25088) + ((((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)) + 1) / 165) * 3136)) + (((int)task_idx.y) * 224)) + (((((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)) + 1) % 165) / 55) * 56)) + (((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)) + 1) % 55)))];
    }
    if ((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)) < 1318) {
      pad_temp_shared[(((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)) + 2))] = placeholder[((((((rc_outer * 25088) + ((((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)) + 2) / 165) * 3136)) + (((int)task_idx.y) * 224)) + (((((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)) + 2) % 165) / 55) * 56)) + (((((((int)threadIdx.z) * 42) + (((int)threadIdx.y) * 21)) + (((int)threadIdx.x) * 3)) + 2) % 55)))];
    }
    if ((((((int)threadIdx.z) * 2) + (((int)threadIdx.x) >> 2)) + ((int)threadIdx.y)) < 64) {
      if ((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) < 512) {
        if (((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)) < 16) {
          if (((int)threadIdx.x) < 4) {
            placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)))] = placeholder1[((((((((int)task_idx.z) * 16384) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 256)) + (rc_outer * 8)) + (((int)threadIdx.x) * 2)))];
          }
        }
      }
    }
    if ((((((int)threadIdx.z) * 2) + (((((int)threadIdx.x) * 2) + 1) >> 3)) + ((int)threadIdx.y)) < 64) {
      if ((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) < 511) {
        if (((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)) < 15) {
          if (((int)threadIdx.x) < 4) {
            placeholder_shared[(((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder1[(((((((((int)task_idx.z) * 16384) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 256)) + (rc_outer * 8)) + (((int)threadIdx.x) * 2)) + 1))];
          }
        }
      }
    }
  ...
  compute[((((((((int)task_idx.z) * 50176) + (((int)threadIdx.z) * 1568)) + (((int)task_idx.y) * 56)) + (((int)threadIdx.y) * 28)) + ((int)threadIdx.x)))] = compute_local[(0)];
  compute[(((((((((int)task_idx.z) * 50176) + (((int)threadIdx.z) * 1568)) + (((int)task_idx.y) * 56)) + (((int)threadIdx.y) * 28)) + ((int)threadIdx.x)) + 7))] = compute_local[(2)];
  compute[(((((((((int)task_idx.z) * 50176) + (((int)threadIdx.z) * 1568)) + (((int)task_idx.y) * 56)) + (((int)threadIdx.y) * 28)) + ((int)threadIdx.x)) + 14))] = compute_local[(4)];
  compute[(((((((((int)task_idx.z) * 50176) + (((int)threadIdx.z) * 1568)) + (((int)task_idx.y) * 56)) + (((int)threadIdx.y) * 28)) + ((int)threadIdx.x)) + 21))] = compute_local[(6)];
  compute[(((((((((int)task_idx.z) * 50176) + (((int)threadIdx.z) * 1568)) + (((int)task_idx.y) * 56)) + (((int)threadIdx.y) * 28)) + ((int)threadIdx.x)) + 784))] = compute_local[(1)];
  compute[(((((((((int)task_idx.z) * 50176) + (((int)threadIdx.z) * 1568)) + (((int)task_idx.y) * 56)) + (((int)threadIdx.y) * 28)) + ((int)threadIdx.x)) + 791))] = compute_local[(3)];
  compute[(((((((((int)task_idx.z) * 50176) + (((int)threadIdx.z) * 1568)) + (((int)task_idx.y) * 56)) + (((int)threadIdx.y) * 28)) + ((int)threadIdx.x)) + 798))] = compute_local[(5)];
  compute[(((((((((int)task_idx.z) * 50176) + (((int)threadIdx.z) * 1568)) + (((int)task_idx.y) * 56)) + (((int)threadIdx.y) * 28)) + ((int)threadIdx.x)) + 805))] = compute_local[(7)];
}
...
__device__  void fused_add_nn_relu_2_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
  for (int ax0_ax1_fused_ax2_fused_ax3_fused_outer = 0; ax0_ax1_fused_ax2_fused_ax3_fused_outer < 7; ++ax0_ax1_fused_ax2_fused_ax3_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer * 65536) + (((int)task_idx.x) * 256)) + ((int)threadIdx.x)) < 401408) {
...
__device__  void fused_nn_conv2d_add_nn_relu_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
    ...
    if (((((((int)threadIdx.y) * 19) + (((int)threadIdx.x) * 3)) >> 7) + ((int)threadIdx.z)) < 8) {
      if ((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 19)) + (((int)threadIdx.x) * 3)) < 1024) {
        if (((((int)threadIdx.y) * 19) + (((int)threadIdx.x) * 3)) < 128) {
          placeholder_shared[((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 19)) + (((int)threadIdx.x) * 3)))] = placeholder1[((((((((int)task_idx.z) * 16384) + (((int)threadIdx.z) * 2048)) + (rc_outer * 128)) + (((int)threadIdx.y) * 19)) + (((int)threadIdx.x) * 3)))];
        }
      }
    }
    if ((((((((int)threadIdx.y) * 19) + (((int)threadIdx.x) * 3)) + 1) >> 7) + ((int)threadIdx.z)) < 8) {
      if ((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 19)) + (((int)threadIdx.x) * 3)) < 1023) {
        if (((((int)threadIdx.y) * 19) + (((int)threadIdx.x) * 3)) < 127) {
          if (((int)threadIdx.x) < 6) {
            placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 19)) + (((int)threadIdx.x) * 3)) + 1))] = placeholder1[(((((((((int)task_idx.z) * 16384) + (((int)threadIdx.z) * 2048)) + (rc_outer * 128)) + (((int)threadIdx.y) * 19)) + (((int)threadIdx.x) * 3)) + 1))];
          }
        }
      }
    }
    if ((((((((int)threadIdx.y) * 19) + (((int)threadIdx.x) * 3)) + 2) >> 7) + ((int)threadIdx.z)) < 8) {
      if ((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 19)) + (((int)threadIdx.x) * 3)) < 1022) {
        if (((((int)threadIdx.y) * 19) + (((int)threadIdx.x) * 3)) < 126) {
          if (((int)threadIdx.x) < 6) {
            placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 19)) + (((int)threadIdx.x) * 3)) + 2))] = placeholder1[(((((((((int)task_idx.z) * 16384) + (((int)threadIdx.z) * 2048)) + (rc_outer * 128)) + (((int)threadIdx.y) * 19)) + (((int)threadIdx.x) * 3)) + 2))];
          }
        }
      }
    }
  ...
  T_relu[(((((((int)task_idx.z) * 392) + (((int)threadIdx.z) * 49)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))] = max((compute[(0)] + placeholder2[(((((int)task_idx.z) * 8) + ((int)threadIdx.z)))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_nn_relu_5_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  for (int rc_outer = 0; rc_outer < 16; ++rc_outer) {
    ...
    if (((((int)threadIdx.z) * 14) + ((int)threadIdx.x)) < 880) {
      pad_temp_shared[(((((int)threadIdx.z) * 14) + ((int)threadIdx.x)))] = placeholder[(((((rc_outer * 50176) + ((((((int)threadIdx.z) * 14) + ((int)threadIdx.x)) / 55) * 3136)) + (((int)task_idx.y) * 112)) + (((((int)threadIdx.z) * 14) + ((int)threadIdx.x)) % 55)))];
    }
    if (((((int)threadIdx.x) >> 3) + ((int)threadIdx.z)) < 64) {
      if (((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 2)) < 1024) {
        if (((int)threadIdx.x) < 8) {
          placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 2)))] = placeholder1[(((((((int)task_idx.z) * 16384) + (((int)threadIdx.z) * 256)) + (rc_outer * 16)) + (((int)threadIdx.x) * 2)))];
        }
      }
    }
    if (((((((int)threadIdx.x) * 2) + 1) >> 4) + ((int)threadIdx.z)) < 64) {
      if (((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 2)) < 1023) {
        if (((int)threadIdx.x) < 8) {
          placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 2)) + 1))] = placeholder1[((((((((int)task_idx.z) * 16384) + (((int)threadIdx.z) * 256)) + (rc_outer * 16)) + (((int)threadIdx.x) * 2)) + 1))];
        }
      }
    }
    __syncthreads();
  ...
  T_relu[(((((((int)task_idx.z) * 50176) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 28)) + ((int)threadIdx.x)))] = max((compute[(0)] + placeholder2[(((((int)task_idx.z) * 64) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((int)task_idx.z) * 50176) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 28)) + ((int)threadIdx.x)) + 14))] = max((compute[(1)] + placeholder2[(((((int)task_idx.z) * 64) + ((int)threadIdx.z)))]), 0.000000e+00f);
}
...
__device__  void fused_add_nn_relu_3_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
  for (int ax0_ax1_fused_ax2_fused_ax3_fused_outer = 0; ax0_ax1_fused_ax2_fused_ax3_fused_outer < 13; ++ax0_ax1_fused_ax2_fused_ax3_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer * 65536) + (((int)task_idx.x) * 256)) + ((int)threadIdx.x)) < 802816) {
...
__device__  void fused_nn_conv2d_add_multiply_add_nn_relu_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3, float* __restrict__ placeholder4){
  ...
  T_relu[(((((((int)task_idx.z) * 784) + (((int)threadIdx.z) * 49)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))] = max(__ocml_fma_f32((compute[(0)] + placeholder2[(((((((int)task_idx.z) * 784) + (((int)threadIdx.z) * 49)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))]), placeholder3[(((((int)task_idx.z) * 16) + ((int)threadIdx.z)))], placeholder4[(((((int)task_idx.z) * 16) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((int)task_idx.z) * 784) + (((int)threadIdx.z) * 49)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 392))] = max(__ocml_fma_f32((compute[(1)] + placeholder2[((((((((int)task_idx.z) * 784) + (((int)threadIdx.z) * 49)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 392))]), placeholder3[((((((int)task_idx.z) * 16) + ((int)threadIdx.z)) + 8))], placeholder4[((((((int)task_idx.z) * 16) + ((int)threadIdx.z)) + 8))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_3_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
      ...
      if ((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 3)) + ((int)threadIdx.x)) < 256) {
        if (((((int)threadIdx.y) * 3) + ((int)threadIdx.x)) < 16) {
          if (((int)threadIdx.x) < 3) {
            placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 3)) + ((int)threadIdx.x)))] = placeholder1[((((((((int)task_idx.z) * 16384) + (((int)threadIdx.z) * 1024)) + (rc_outer * 16)) + (((int)threadIdx.y) * 3)) + ((int)threadIdx.x)))];
          }
        }
      }
    }
  ...
  compute[(((((((int)task_idx.z) * 784) + (((int)threadIdx.z) * 49)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))] = compute_local[(0)];
}
...
__device__  void fused_nn_conv2d_add_1_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  ...
  T_add[((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)))] = (compute[(0)] + placeholder2[((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)))]);
  T_add[(((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 3136))] = (compute[(2)] + placeholder2[(((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 3136))]);
  T_add[(((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 1))] = (compute[(1)] + placeholder2[(((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 1))]);
  T_add[(((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 3137))] = (compute[(3)] + placeholder2[(((((((((int)task_idx.z) * 6272) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 3137))]);
}
...
__device__  void fused_nn_conv2d_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
  ...
  compute[(((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)))] = compute_local[(0)];
  compute[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50176))] = compute_local[(2)];
  compute[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100352))] = compute_local[(4)];
  compute[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 150528))] = compute_local[(6)];
  compute[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = compute_local[(1)];
  compute[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50177))] = compute_local[(3)];
  compute[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100353))] = compute_local[(5)];
  compute[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 150529))] = compute_local[(7)];
}
