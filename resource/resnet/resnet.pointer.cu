...
__device__ __noinline__ void fused_add_14_kernel0_device(float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__ __noinline__ void fused_nn_conv2d_add_nn_relu_7_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[4];
...
__device__ __noinline__ void fused_nn_conv2d_add_3_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  float compute[8];
...
__device__ __noinline__ void fused_nn_conv2d_add_add_nn_relu_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3){
  float compute[8];
...
__device__ __noinline__ void fused_nn_conv2d_add_nn_relu_4_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[2];
  __shared__ float pad_temp_shared[896];
  __shared__ float placeholder_shared[256];
  compute[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_conv2d_add_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  float compute[8];
  __shared__ float pad_temp_shared[896];
  __shared__ float placeholder_shared[256];
  for (int xx_init = 0; xx_init < 2; ++xx_init) {
...
__device__ __noinline__ void fused_nn_conv2d_add_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  float compute[2];
...
__device__ __noinline__ void fused_nn_conv2d_add_add_nn_relu_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3){
  float compute[8];
  __shared__ float pad_temp_shared[512];
  __shared__ float placeholder_shared[1024];
  compute[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_conv2d_add_add_nn_relu_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3){
  float compute[4];
...
__device__ __noinline__ void fused_nn_conv2d_add_nn_relu_6_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[4];
  __shared__ float pad_temp_shared[256];
  __shared__ float placeholder_shared[512];
  compute[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_conv2d_add_nn_relu_8_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[16];
...
__device__ __noinline__ void fused_nn_conv2d_add_nn_relu_5_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[2];
...
__device__ __noinline__ void fused_nn_conv2d_add_multiply_add_nn_relu_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3, float* __restrict__ placeholder4){
  float compute[2];
  __shared__ float pad_temp_shared[784];
  __shared__ float placeholder_shared[256];
  compute[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_conv2d_add_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  float compute[4];
  __shared__ float pad_temp_shared[1568];
  __shared__ float placeholder_shared[512];
  compute[(0)] = 0.000000e+00f;
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_add_14_kernel0(float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_nn_relu_7_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    fused_nn_conv2d_add_nn_relu_7_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_3_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_add_nn_relu_1_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3) {
    fused_nn_conv2d_add_add_nn_relu_1_kernel0_device(placeholder, placeholder1, T_relu, placeholder2, placeholder3);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_nn_relu_4_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    fused_nn_conv2d_add_nn_relu_4_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_2_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_add_nn_relu_2_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_add_nn_relu_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_nn_relu_6_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_nn_relu_8_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    fused_nn_conv2d_add_nn_relu_8_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_nn_relu_5_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_1_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
...
extern "C" __global__ void _get_func_pointers(unsigned long long int *address) {
    address[0] = (unsigned long long int)&fused_add_14_kernel0_device;
    ...
    address[6] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel0_device;
    address[7] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel1_device;
    address[8] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel2_device;
    address[9] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel0_device;
    address[10] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel1_device;
    address[11] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel2_device;
    address[12] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel0_device;
    address[13] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel1_device;
    address[14] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel2_device;
    address[15] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel0_device;
    address[16] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel1_device;
    address[17] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel2_device;
    address[18] = (unsigned long long int)&fused_nn_conv2d_1_kernel0_device;
    address[19] = (unsigned long long int)&fused_nn_conv2d_2_kernel0_device;
    address[20] = (unsigned long long int)&fused_nn_conv2d_3_kernel0_device;
    address[21] = (unsigned long long int)&fused_nn_conv2d_add_1_kernel0_device;
    address[22] = (unsigned long long int)&fused_nn_conv2d_add_2_kernel0_device;
    address[23] = (unsigned long long int)&fused_nn_conv2d_add_3_kernel0_device;
    address[24] = (unsigned long long int)&fused_nn_conv2d_add_add_nn_relu_1_kernel0_device;
    address[25] = (unsigned long long int)&fused_nn_conv2d_add_add_nn_relu_2_kernel0_device;
    address[26] = (unsigned long long int)&fused_nn_conv2d_add_add_nn_relu_kernel0_device;
    address[27] = (unsigned long long int)&fused_nn_conv2d_add_kernel0_device;
    address[28] = (unsigned long long int)&fused_nn_conv2d_add_multiply_add_nn_relu_kernel0_device;
    address[29] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_1_kernel0_device;
    address[30] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_2_kernel0_device;
    address[31] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_3_kernel0_device;
    address[32] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_4_kernel0_device;
    address[33] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_5_kernel0_device;
    address[34] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_6_kernel0_device;
    address[35] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_7_kernel0_device;
    address[36] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_8_kernel0_device;
    address[37] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_kernel0_device;
    address[38] = (unsigned long long int)&fused_nn_conv2d_kernel0_device;
    address[39] = (unsigned long long int)&fused_nn_dense_add_kernel0_device;
    address[40] = (unsigned long long int)&fused_nn_global_avg_pool2d_kernel0_device;
    address[41] = (unsigned long long int)&fused_nn_max_pool2d_add_nn_relu_kernel0_device;
    address[42] = (unsigned long long int)&fused_nn_softmax_kernel0_device;
