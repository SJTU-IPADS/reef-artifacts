...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder){
  float inverse[4];
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[8];
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
  float inverse[4];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[8];
  __shared__ float placeholder_shared[512];
  __shared__ float data_pack_shared[3136];
  bgemm_local[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[8];
  __shared__ float placeholder_shared[512];
  __shared__ float data_pack_shared[3136];
  bgemm_local[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
  float data_pack_local[16];
  for (int eps = 0; eps < 4; ++eps) {
    for (int nu = 0; nu < 4; ++nu) {
...
__device__ __noinline__ void fused_nn_softmax_kernel0_device(float* __restrict__ placeholder, float* __restrict__ T_softmax_norm){
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[36];
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[36];
  float data_pack_local[36];
  for (int eps = 0; eps < 6; ++eps) {
    for (int nu = 0; nu < 6; ++nu) {
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
  __shared__ float placeholder_shared[512];
...
__device__ __noinline__ void fused_nn_conv2d_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder){
  float inverse[16];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
  float data_pack_local[16];
  for (int eps = 0; eps < 4; ++eps) {
    for (int nu = 0; nu < 4; ++nu) {
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder){
  float inverse[4];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 25088))]);
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder){
  float inverse[4];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 25088))]);
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[36];
  float data_pack_local[36];
  for (int eps = 0; eps < 6; ++eps) {
    for (int nu = 0; nu < 6; ++nu) {
...
__device__ __noinline__ void fused_add_nn_relu_3_kernel0_device(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
  float data_pack_local[16];
  for (int eps = 0; eps < 4; ++eps) {
    for (int nu = 0; nu < 4; ++nu) {
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
  float data_pack_local[16];
  for (int eps = 0; eps < 4; ++eps) {
    for (int nu = 0; nu < 4; ++nu) {
...
__device__ __noinline__ void fused_add_nn_relu_kernel0_device(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder){
  float inverse[16];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12544))]);
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
  __shared__ float placeholder_shared[512];
  __shared__ float data_pack_shared[1568];
  bgemm_local[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
  float inverse[16];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12544))]);
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
  float data_pack_local[16];
  for (int eps = 0; eps < 4; ++eps) {
    for (int nu = 0; nu < 4; ++nu) {
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
  float inverse[4];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12544))]);
...
__device__ __noinline__ void fused_nn_conv2d_add_nn_relu_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[2];
...
__device__ __noinline__ void fused_nn_conv2d_add_nn_relu_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[4];
...
__device__ __noinline__ void fused_nn_global_avg_pool2d_kernel0_device(float* __restrict__ placeholder, float* __restrict__ tensor){
  float tensor1[1];
...
__device__ __noinline__ void fused_nn_dense_add_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  float T_dense_rf[1];
  float red_buf0[1];
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ placeholder2){
  float inverse[4];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 8192))]);
...
__device__ __noinline__ void fused_nn_conv2d_add_nn_relu_3_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[16];
...
__device__ __noinline__ void fused_nn_conv2d_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
...
__device__ __noinline__ void fused_add_nn_relu_1_kernel0_device(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
  __shared__ float placeholder_shared[1024];
  __shared__ float data_pack_shared[256];
  bgemm_local[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
  float data_pack_local[16];
  for (int eps = 0; eps < 4; ++eps) {
    for (int nu = 0; nu < 4; ++nu) {
...
__device__ __noinline__ void fused_nn_batch_flatten_kernel0_device(float* __restrict__ tensor, float* __restrict__ placeholder){
  tensor[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)))] = placeholder[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)))];
}

__device__ __noinline__ void fused_nn_conv2d_add_nn_relu_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[1];
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder){
  float inverse[4];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12544))]);
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder){
  float inverse[4];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12544))]);
...
__device__ __noinline__ void fused_add_nn_relu_2_kernel0_device(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__ __noinline__ void fused_nn_conv2d_3_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
  __shared__ float placeholder_shared[1024];
  __shared__ float data_pack_shared[256];
  bgemm_local[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_max_pool2d_add_nn_relu_kernel0_device(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1){
  float tensor[1];
...
__device__ __noinline__ void fused_nn_conv2d_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
  __shared__ float placeholder_shared[2048];
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
  __shared__ float placeholder_shared[2048];
  __shared__ float data_pack_shared[896];
  bgemm_local[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder){
  float inverse[4];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 8192))]);
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
  __shared__ float placeholder_shared[2048];
  __shared__ float data_pack_shared[896];
  bgemm_local[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
  __shared__ float placeholder_shared[512];
  __shared__ float data_pack_shared[1568];
  bgemm_local[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
  float data_pack_local[16];
  for (int eps = 0; eps < 4; ++eps) {
    for (int nu = 0; nu < 4; ++nu) {
...
__device__ __noinline__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
  float data_pack_local[16];
  for (int eps = 0; eps < 4; ++eps) {
    for (int nu = 0; nu < 4; ++nu) {
...
__device__ __noinline__ void fused_add_10_kernel0_device(float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel0(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel0_device(placeholder, data_pack);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel2(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel2_device(bgemm, T_relu, placeholder);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel1(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel1_device(placeholder, data_pack, bgemm);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel2(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel1(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel1_device(placeholder, data_pack, bgemm);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel1(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel1_device(placeholder, data_pack, bgemm);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel1(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel1_device(placeholder, data_pack, bgemm);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel0(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel0_device(placeholder, data_pack);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_softmax_kernel0(float* __restrict__ placeholder, float* __restrict__ T_softmax_norm) {
    fused_nn_softmax_kernel0_device(placeholder, T_softmax_norm);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel0(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel0_device(placeholder, data_pack);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel0(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel0_device(placeholder, data_pack);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel1(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel1_device(placeholder, data_pack, bgemm);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_1_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    fused_nn_conv2d_1_kernel0_device(placeholder, placeholder1, compute);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel2(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel2_device(bgemm, T_add, placeholder);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel0(float* __restrict__ placeholder, float* __restrict__ data_pack) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel2(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel2_device(bgemm, T_add, placeholder);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel2(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel2_device(bgemm, T_relu, placeholder);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel0(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel0_device(placeholder, data_pack);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_add_nn_relu_3_kernel0(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    fused_add_nn_relu_3_kernel0_device(T_relu, placeholder, placeholder1);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel0(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel0_device(placeholder, data_pack);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel0(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel0_device(placeholder, data_pack);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_add_nn_relu_kernel0(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    fused_add_nn_relu_kernel0_device(T_relu, placeholder, placeholder1);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel2(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel2_device(bgemm, T_relu, placeholder);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel1(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel1_device(placeholder, data_pack, bgemm);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel2(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel0(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel0_device(placeholder, data_pack);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel2(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_nn_relu_1_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    fused_nn_conv2d_add_nn_relu_1_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_nn_relu_2_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    fused_nn_conv2d_add_nn_relu_2_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_global_avg_pool2d_kernel0(float* __restrict__ placeholder, float* __restrict__ tensor) {
    fused_nn_global_avg_pool2d_kernel0_device(placeholder, tensor);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_dense_add_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
    fused_nn_dense_add_kernel0_device(placeholder, placeholder1, T_add, placeholder2);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel2(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ placeholder2) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_nn_relu_3_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    fused_nn_conv2d_add_nn_relu_3_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_2_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    fused_nn_conv2d_2_kernel0_device(placeholder, placeholder1, compute);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_add_nn_relu_1_kernel0(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    fused_add_nn_relu_1_kernel0_device(T_relu, placeholder, placeholder1);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel1(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel0(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel0_device(placeholder, data_pack);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_batch_flatten_kernel0(float* __restrict__ tensor, float* __restrict__ placeholder) {
    fused_nn_batch_flatten_kernel0_device(tensor, placeholder);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_nn_relu_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    fused_nn_conv2d_add_nn_relu_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel2(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel2_device(bgemm, T_relu, placeholder);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel2(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel2_device(bgemm, T_add, placeholder);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_add_nn_relu_2_kernel0(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    fused_add_nn_relu_2_kernel0_device(T_relu, placeholder, placeholder1);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_3_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    fused_nn_conv2d_3_kernel0_device(placeholder, placeholder1, compute);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel1(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel1_device(placeholder, data_pack, bgemm);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_max_pool2d_add_nn_relu_kernel0(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1) {
    fused_nn_max_pool2d_add_nn_relu_kernel0_device(placeholder, T_relu, placeholder1);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    fused_nn_conv2d_kernel0_device(placeholder, placeholder1, compute);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel1(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel1_device(placeholder, data_pack, bgemm);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel1(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel1_device(placeholder, data_pack, bgemm);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel2(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel2_device(bgemm, T_add, placeholder);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel1(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel1_device(placeholder, data_pack, bgemm);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel1(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel1_device(placeholder, data_pack, bgemm);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel0(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel0_device(placeholder, data_pack);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel0(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel0_device(placeholder, data_pack);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_add_10_kernel0(float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
...
extern "C" __global__ void _get_func_pointers(unsigned long long int *address) {
    address[0] = (unsigned long long int)&fused_add_10_kernel0_device;
    address[1] = (unsigned long long int)&fused_add_nn_relu_1_kernel0_device;
    address[2] = (unsigned long long int)&fused_add_nn_relu_2_kernel0_device;
    address[3] = (unsigned long long int)&fused_add_nn_relu_3_kernel0_device;
    address[4] = (unsigned long long int)&fused_add_nn_relu_kernel0_device;
    address[5] = (unsigned long long int)&fused_nn_batch_flatten_kernel0_device;
    address[6] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel0_device;
    address[7] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel1_device;
    address[8] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel2_device;
    address[9] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel0_device;
    address[10] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel1_device;
    address[11] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel2_device;
    address[12] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel0_device;
    address[13] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel1_device;
    address[14] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel2_device;
    address[15] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel0_device;
    address[16] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel1_device;
    address[17] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel2_device;
    address[18] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel0_device;
    address[19] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel1_device;
    address[20] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel2_device;
    address[21] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel0_device;
    address[22] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel1_device;
    address[23] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel2_device;
    address[24] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel0_device;
    address[25] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel1_device;
    address[26] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel2_device;
    address[27] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel0_device;
    address[28] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel1_device;
    address[29] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel2_device;
    address[30] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel0_device;
    address[31] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel1_device;
    address[32] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel2_device;
    address[33] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel0_device;
    address[34] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel1_device;
    address[35] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel2_device;
    address[36] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel0_device;
    address[37] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel1_device;
    address[38] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel2_device;
    address[39] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel0_device;
    address[40] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel1_device;
    address[41] = (unsigned long long int)&fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel2_device;
    address[42] = (unsigned long long int)&fused_nn_conv2d_1_kernel0_device;
    address[43] = (unsigned long long int)&fused_nn_conv2d_2_kernel0_device;
    address[44] = (unsigned long long int)&fused_nn_conv2d_3_kernel0_device;
    address[45] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_1_kernel0_device;
    address[46] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_2_kernel0_device;
    address[47] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_3_kernel0_device;
    address[48] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_kernel0_device;
    address[49] = (unsigned long long int)&fused_nn_conv2d_kernel0_device;
    address[50] = (unsigned long long int)&fused_nn_dense_add_kernel0_device;
    address[51] = (unsigned long long int)&fused_nn_global_avg_pool2d_kernel0_device;
    address[52] = (unsigned long long int)&fused_nn_max_pool2d_add_nn_relu_kernel0_device;
    address[53] = (unsigned long long int)&fused_nn_softmax_kernel0_device;
