...
__device__  void fused_nn_conv2d_add_nn_relu_12_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  for (int rc_outer = 0; rc_outer < 8; ++rc_outer) {
    ...
    placeholder_shared[((((((int)threadIdx.z) * 64) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)))] = placeholder1[((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 128)) + (rc_outer * 16)) + (((int)threadIdx.x) * 4)))];
    placeholder_shared[(((((((int)threadIdx.z) * 64) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 128)) + (rc_outer * 16)) + (((int)threadIdx.x) * 4)) + 1))];
    placeholder_shared[(((((((int)threadIdx.z) * 64) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 128)) + (rc_outer * 16)) + (((int)threadIdx.x) * 4)) + 2))];
    placeholder_shared[(((((((int)threadIdx.z) * 64) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 128)) + (rc_outer * 16)) + (((int)threadIdx.x) * 4)) + 3))];
    __syncthreads();
  ...
  T_relu[(((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)))] = max((compute[(0)] + placeholder2[(((((int)task_idx.z) * 64) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50176))] = max((compute[(2)] + placeholder2[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 16))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100352))] = max((compute[(4)] + placeholder2[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 32))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 150528))] = max((compute[(6)] + placeholder2[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 48))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = max((compute[(1)] + placeholder2[(((((int)task_idx.z) * 64) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50177))] = max((compute[(3)] + placeholder2[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 16))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100353))] = max((compute[(5)] + placeholder2[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 32))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 150529))] = max((compute[(7)] + placeholder2[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 48))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_nn_relu_7_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  for (int ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer = 0; ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer < 5; ++ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer) {
    if ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer * 196) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)) < 841) {
      if (((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer * 14) + ((int)threadIdx.y)) < 61) {
        PaddedInput_shared[((((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer * 196) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)))] = (((29 <= (((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer * 196) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x))) && (1 <= ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer * 196) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)) % 29))) ? placeholder[(((((((int)task_idx.z) * 784) + (((((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer * 196) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)) / 29) * 28)) + ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer * 196) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)) % 29)) - 29))] : 0.000000e+00f);
      }
    }
  }
  if (((((int)threadIdx.y) * 14) + ((int)threadIdx.x)) < 9) {
    if (((int)threadIdx.y) < 1) {
      placeholder_shared[(((((int)threadIdx.y) * 14) + ((int)threadIdx.x)))] = placeholder1[((((((int)threadIdx.y) * 14) + (((int)task_idx.z) * 9)) + ((int)threadIdx.x)))];
    }
  }
  __syncthreads();
  ...
  T_relu[((((((int)task_idx.z) * 196) + (((int)threadIdx.y) * 14)) + ((int)threadIdx.x)))] = max((DepthwiseConv2d[(0)] + placeholder2[(((int)task_idx.z))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_nn_relu_6_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  for (int rc_outer = 0; rc_outer < 16; ++rc_outer) {
    __syncthreads();
    pad_temp_shared[((((((int)threadIdx.z) * 14) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))] = placeholder[(((((((rc_outer * 3136) + ((((int)threadIdx.z) >> 1) * 196)) + (((int)task_idx.y) * 28)) + ((((int)threadIdx.z) & 1) * 14)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))];
      ...
      if ((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) < 512) {
        if (((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)) < 16) {
          if (((int)threadIdx.x) < 4) {
            placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)))] = placeholder1[((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 256)) + (rc_outer * 16)) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)))];
          }
        }
      }
    }
    if ((((((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)) + 1) >> 4) + ((int)threadIdx.z)) < 32) {
      if ((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) < 511) {
        if (((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)) < 15) {
          if (((int)threadIdx.x) < 4) {
            placeholder_shared[(((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder1[(((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 256)) + (rc_outer * 16)) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + 1))];
          }
        }
      }
    }
...
__device__  void fused_nn_conv2d_add_nn_relu_14_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[8];
  __shared__ float pad_temp_shared[512];
  __shared__ float placeholder_shared[1024];
  compute[(0)] = 0.000000e+00f;
  ...
  for (int rc_outer = 0; rc_outer < 4; ++rc_outer) {
    __syncthreads();
    pad_temp_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)))] = placeholder[(((((((rc_outer * 50176) + ((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) >> 2) * 3136)) + (((int)task_idx.y) * 224)) + ((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) & 3) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)))];
    pad_temp_shared[(((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder[((((((((rc_outer * 50176) + ((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) >> 2) * 3136)) + (((int)task_idx.y) * 224)) + ((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) & 3) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 1))];
    placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)))] = placeholder1[((((((((int)task_idx.z) * 4096) + (((int)threadIdx.z) * 128)) + (((int)threadIdx.y) * 64)) + (rc_outer * 16)) + (((int)threadIdx.x) * 4)))];
    placeholder_shared[(((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((((int)task_idx.z) * 4096) + (((int)threadIdx.z) * 128)) + (((int)threadIdx.y) * 64)) + (rc_outer * 16)) + (((int)threadIdx.x) * 4)) + 1))];
    placeholder_shared[(((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((((int)task_idx.z) * 4096) + (((int)threadIdx.z) * 128)) + (((int)threadIdx.y) * 64)) + (rc_outer * 16)) + (((int)threadIdx.x) * 4)) + 2))];
    placeholder_shared[(((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((((int)task_idx.z) * 4096) + (((int)threadIdx.z) * 128)) + (((int)threadIdx.y) * 64)) + (rc_outer * 16)) + (((int)threadIdx.x) * 4)) + 3))];
    __syncthreads();
    compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
    compute[(4)] = __ocml_fma_f32(pad_temp_shared[(((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)))], placeholder_shared[(((((int)threadIdx.z) * 16) + 512))], compute[(4)]);
  ...
  T_relu[(((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)))] = max((compute[(0)] + placeholder2[(((((int)task_idx.z) * 64) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100352))] = max((compute[(4)] + placeholder2[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 32))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 112))] = max((compute[(2)] + placeholder2[(((((int)task_idx.z) * 64) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100464))] = max((compute[(6)] + placeholder2[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 32))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = max((compute[(1)] + placeholder2[(((((int)task_idx.z) * 64) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100353))] = max((compute[(5)] + placeholder2[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 32))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 113))] = max((compute[(3)] + placeholder2[(((((int)task_idx.z) * 64) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100465))] = max((compute[(7)] + placeholder2[((((((int)task_idx.z) * 64) + ((int)threadIdx.z)) + 32))]), 0.000000e+00f);
}

__device__  void fused_nn_conv2d_add_nn_relu_18_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[7];
  ...
  for (int rc_outer = 0; rc_outer < 3; ++rc_outer) {
    ...
    if (((((int)threadIdx.z) * 16) + ((int)threadIdx.x)) < 495) {
      pad_temp_shared[(((((int)threadIdx.z) * 16) + ((int)threadIdx.x)))] = (((1 <= ((((int)task_idx.y) * 14) + (((((int)threadIdx.z) * 16) + ((int)threadIdx.x)) / 33))) && (1 <= ((((int)task_idx.x) * 32) + (((((int)threadIdx.z) * 16) + ((int)threadIdx.x)) % 33)))) ? placeholder[(((((((rc_outer * 50176) + (((int)task_idx.y) * 3136)) + ((((((int)threadIdx.z) * 16) + ((int)threadIdx.x)) / 33) * 224)) + (((int)task_idx.x) * 32)) + (((((int)threadIdx.z) * 16) + ((int)threadIdx.x)) % 33)) - 225))] : 0.000000e+00f);
    }
  ...
  for (int ax2_inner_inner_inner = 0; ax2_inner_inner_inner < 7; ++ax2_inner_inner_inner) {
    T_relu[((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 784)) + (ax2_inner_inner_inner * 112)) + (((int)task_idx.x) * 16)) + ((int)threadIdx.x)))] = max((compute[(ax2_inner_inner_inner)] + placeholder2[(((int)threadIdx.z))]), 0.000000e+00f);
  }
}

__device__  void fused_nn_conv2d_add_nn_relu_17_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  __shared__ float PaddedInput_shared[1824];
  __shared__ float placeholder_shared[9];
  float PaddedInput_shared_local[18];
  float placeholder_shared_local[9];
  float DepthwiseConv2d[4];
  PaddedInput_shared[(((((int)threadIdx.y) * 28) + ((int)threadIdx.x)))] = ((((1 <= ((((int)task_idx.y) * 14) + (((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) / 114))) && (1 <= (((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) % 114))) && ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) % 114) < 113)) ? placeholder[((((((((int)task_idx.z) * 12544) + (((int)task_idx.y) * 1568)) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) / 114) * 112)) + (((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) % 114)) - 113))] : 0.000000e+00f);
  PaddedInput_shared[((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 392))] = (((1 <= ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 50) % 114)) && (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 50) % 114) < 113)) ? placeholder[((((((((int)task_idx.z) * 12544) + (((int)task_idx.y) * 1568)) + (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 392) / 114) * 112)) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 50) % 114)) - 113))] : 0.000000e+00f);
  PaddedInput_shared[((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 784))] = (((1 <= ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 100) % 114)) && (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 100) % 114) < 113)) ? placeholder[((((((((int)task_idx.z) * 12544) + (((int)task_idx.y) * 1568)) + (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 784) / 114) * 112)) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 100) % 114)) - 113))] : 0.000000e+00f);
  PaddedInput_shared[((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 1176))] = (((1 <= ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 36) % 114)) && (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 36) % 114) < 113)) ? placeholder[((((((((int)task_idx.z) * 12544) + (((int)task_idx.y) * 1568)) + (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 1176) / 114) * 112)) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 36) % 114)) - 113))] : 0.000000e+00f);
  if (((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) < 256) {
    if (((int)threadIdx.y) < 10) {
      PaddedInput_shared[((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 1568))] = ((((((((int)task_idx.y) * 14) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 1568) / 114)) < 113) && (1 <= ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 86) % 114))) && (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 86) % 114) < 113)) ? placeholder[((((((((int)task_idx.z) * 12544) + (((int)task_idx.y) * 1568)) + (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 1568) / 114) * 112)) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 86) % 114)) - 113))] : 0.000000e+00f);
    }
  }
  if (((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) < 9) {
    if (((int)threadIdx.y) < 1) {
      placeholder_shared[(((((int)threadIdx.y) * 28) + ((int)threadIdx.x)))] = placeholder1[((((((int)threadIdx.y) * 28) + (((int)task_idx.z) * 9)) + ((int)threadIdx.x)))];
    }
  }
  __syncthreads();
  ...
  T_relu[(((((((int)task_idx.z) * 12544) + (((int)task_idx.y) * 1568)) + (((int)threadIdx.y) * 112)) + (((int)threadIdx.x) * 4)))] = max((DepthwiseConv2d[(0)] + placeholder2[(((int)task_idx.z))]), 0.000000e+00f);
  T_relu[((((((((int)task_idx.z) * 12544) + (((int)task_idx.y) * 1568)) + (((int)threadIdx.y) * 112)) + (((int)threadIdx.x) * 4)) + 1))] = max((DepthwiseConv2d[(1)] + placeholder2[(((int)task_idx.z))]), 0.000000e+00f);
  T_relu[((((((((int)task_idx.z) * 12544) + (((int)task_idx.y) * 1568)) + (((int)threadIdx.y) * 112)) + (((int)threadIdx.x) * 4)) + 2))] = max((DepthwiseConv2d[(2)] + placeholder2[(((int)task_idx.z))]), 0.000000e+00f);
  T_relu[((((((((int)task_idx.z) * 12544) + (((int)task_idx.y) * 1568)) + (((int)threadIdx.y) * 112)) + (((int)threadIdx.x) * 4)) + 3))] = max((DepthwiseConv2d[(3)] + placeholder2[(((int)task_idx.z))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_nn_relu_11_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  float placeholder_shared_local[9];
  float DepthwiseConv2d[1];
  PaddedInput_shared[(((((int)threadIdx.y) * 28) + ((int)threadIdx.x)))] = (((57 <= ((((int)threadIdx.y) * 28) + ((int)threadIdx.x))) && (1 <= (((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) % 57))) ? placeholder[(((((((int)task_idx.z) * 3136) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) / 57) * 56)) + (((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) % 57)) - 57))] : 0.000000e+00f);
  PaddedInput_shared[((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 784))] = ((1 <= ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 43) % 57)) ? placeholder[(((((((int)task_idx.z) * 3136) + (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 784) / 57) * 56)) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 43) % 57)) - 57))] : 0.000000e+00f);
  PaddedInput_shared[((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 1568))] = ((1 <= ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 29) % 57)) ? placeholder[(((((((int)task_idx.z) * 3136) + (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 1568) / 57) * 56)) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 29) % 57)) - 57))] : 0.000000e+00f);
  PaddedInput_shared[((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 2352))] = ((1 <= ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 15) % 57)) ? placeholder[(((((((int)task_idx.z) * 3136) + (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 2352) / 57) * 56)) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 15) % 57)) - 57))] : 0.000000e+00f);
  if (((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) < 113) {
    if (((int)threadIdx.y) < 5) {
      PaddedInput_shared[((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 3136))] = ((1 <= ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 1) % 57)) ? placeholder[(((((((int)task_idx.z) * 3136) + (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 3136) / 57) * 56)) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 1) % 57)) - 57))] : 0.000000e+00f);
    }
  }
  if (((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) < 9) {
    if (((int)threadIdx.y) < 1) {
  ...
  T_relu[((((((int)task_idx.z) * 784) + (((int)threadIdx.y) * 28)) + ((int)threadIdx.x)))] = max((DepthwiseConv2d[(0)] + placeholder2[(((int)task_idx.z))]), 0.000000e+00f);
}

__device__  void fused_nn_conv2d_add_nn_relu_16_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[16];
  ...
  for (int rc_outer = 0; rc_outer < 2; ++rc_outer) {
    __syncthreads();
    pad_temp_shared[((((((int)threadIdx.z) * 64) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)))] = placeholder[(((((((rc_outer * 200704) + (((int)threadIdx.z) * 12544)) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)))];
    pad_temp_shared[(((((((int)threadIdx.z) * 64) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)) + 1))] = placeholder[((((((((rc_outer * 200704) + (((int)threadIdx.z) * 12544)) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 1))];
    pad_temp_shared[(((((((int)threadIdx.z) * 64) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)) + 2))] = placeholder[((((((((rc_outer * 200704) + (((int)threadIdx.z) * 12544)) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 2))];
    pad_temp_shared[(((((((int)threadIdx.z) * 64) + (((int)threadIdx.y) * 16)) + (((int)threadIdx.x) * 4)) + 3))] = placeholder[((((((((rc_outer * 200704) + (((int)threadIdx.z) * 12544)) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 3))];
  ...
  T_relu[((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)))] = max((compute[(0)] + placeholder2[(((int)threadIdx.z))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 200704))] = max((compute[(4)] + placeholder2[((((int)threadIdx.z) + 16))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 401408))] = max((compute[(8)] + placeholder2[((((int)threadIdx.z) + 32))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 602112))] = max((compute[(12)] + placeholder2[((((int)threadIdx.z) + 48))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 1))] = max((compute[(1)] + placeholder2[(((int)threadIdx.z))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 200705))] = max((compute[(5)] + placeholder2[((((int)threadIdx.z) + 16))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 401409))] = max((compute[(9)] + placeholder2[((((int)threadIdx.z) + 32))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 602113))] = max((compute[(13)] + placeholder2[((((int)threadIdx.z) + 48))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 2))] = max((compute[(2)] + placeholder2[(((int)threadIdx.z))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 200706))] = max((compute[(6)] + placeholder2[((((int)threadIdx.z) + 16))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 401410))] = max((compute[(10)] + placeholder2[((((int)threadIdx.z) + 32))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 602114))] = max((compute[(14)] + placeholder2[((((int)threadIdx.z) + 48))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 3))] = max((compute[(3)] + placeholder2[(((int)threadIdx.z))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 200707))] = max((compute[(7)] + placeholder2[((((int)threadIdx.z) + 16))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 401411))] = max((compute[(11)] + placeholder2[((((int)threadIdx.z) + 32))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 12544) + (((int)task_idx.y) * 448)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 16)) + (((int)threadIdx.x) * 4)) + 602115))] = max((compute[(15)] + placeholder2[((((int)threadIdx.z) + 48))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_nn_relu_2_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
      ...
      if ((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 5)) + ((int)threadIdx.x)) < 512) {
        if (((((int)threadIdx.y) * 5) + ((int)threadIdx.x)) < 32) {
          if (((int)threadIdx.x) < 5) {
            placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 5)) + ((int)threadIdx.x)))] = placeholder1[((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 512)) + (rc_outer * 32)) + (((int)threadIdx.y) * 5)) + ((int)threadIdx.x)))];
          }
        }
      }
    }
  ...
  T_relu[(((((((int)task_idx.z) * 784) + (((int)threadIdx.z) * 49)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))] = max((compute[(0)] + placeholder2[(((((int)task_idx.z) * 16) + ((int)threadIdx.z)))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_nn_relu_13_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  __shared__ float PaddedInput_shared[3364];
  __shared__ float placeholder_shared[9];
  float PaddedInput_shared_local[16];
  float placeholder_shared_local[9];
  float DepthwiseConv2d[4];
  PaddedInput_shared[(((((int)threadIdx.y) * 28) + ((int)threadIdx.x)))] = ((((58 <= ((((int)threadIdx.y) * 28) + ((int)threadIdx.x))) && (1 <= (((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) % 58))) && ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) % 58) < 57)) ? placeholder[(((((((int)task_idx.z) * 3136) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) / 58) * 56)) + (((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) % 58)) - 57))] : 0.000000e+00f);
  PaddedInput_shared[((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 784))] = (((1 <= ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 30) % 58)) && (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 30) % 58) < 57)) ? placeholder[(((((((int)task_idx.z) * 3136) + (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 784) / 58) * 56)) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 30) % 58)) - 57))] : 0.000000e+00f);
  PaddedInput_shared[((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 1568))] = (((1 <= ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 2) % 58)) && (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 2) % 58) < 57)) ? placeholder[(((((((int)task_idx.z) * 3136) + (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 1568) / 58) * 56)) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 2) % 58)) - 57))] : 0.000000e+00f);
  PaddedInput_shared[((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 2352))] = (((1 <= ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 32) % 58)) && (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 32) % 58) < 57)) ? placeholder[(((((((int)task_idx.z) * 3136) + (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 2352) / 58) * 56)) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 32) % 58)) - 57))] : 0.000000e+00f);
  if (((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) < 228) {
    if (((int)threadIdx.y) < 9) {
      PaddedInput_shared[((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 3136))] = ((((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) < 170) && (1 <= ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 4) % 58))) && (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 4) % 58) < 57)) ? placeholder[(((((((int)task_idx.z) * 3136) + (((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 3136) / 58) * 56)) + ((((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) + 4) % 58)) - 57))] : 0.000000e+00f);
    }
  }
  if (((((int)threadIdx.y) * 28) + ((int)threadIdx.x)) < 9) {
    if (((int)threadIdx.y) < 1) {
  ...
  T_relu[((((((int)task_idx.z) * 3136) + (((int)threadIdx.y) * 112)) + (((int)threadIdx.x) * 2)))] = max((DepthwiseConv2d[(0)] + placeholder2[(((int)task_idx.z))]), 0.000000e+00f);
  T_relu[(((((((int)task_idx.z) * 3136) + (((int)threadIdx.y) * 112)) + (((int)threadIdx.x) * 2)) + 1))] = max((DepthwiseConv2d[(1)] + placeholder2[(((int)task_idx.z))]), 0.000000e+00f);
  T_relu[(((((((int)task_idx.z) * 3136) + (((int)threadIdx.y) * 112)) + (((int)threadIdx.x) * 2)) + 56))] = max((DepthwiseConv2d[(2)] + placeholder2[(((int)task_idx.z))]), 0.000000e+00f);
  T_relu[(((((((int)task_idx.z) * 3136) + (((int)threadIdx.y) * 112)) + (((int)threadIdx.x) * 2)) + 57))] = max((DepthwiseConv2d[(3)] + placeholder2[(((int)task_idx.z))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_nn_relu_8_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  for (int rc_outer = 0; rc_outer < 16; ++rc_outer) {
    __syncthreads();
    pad_temp_shared[((((((int)threadIdx.z) * 112) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)))] = placeholder[((((((rc_outer * 12544) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)))];
    pad_temp_shared[(((((((int)threadIdx.z) * 112) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder[(((((((rc_outer * 12544) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + 1))];
      ...
      if ((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 8)) + ((int)threadIdx.x)) < 512) {
        if (((((int)threadIdx.y) * 8) + ((int)threadIdx.x)) < 32) {
          if (((int)threadIdx.x) < 8) {
            placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 8)) + ((int)threadIdx.x)))] = placeholder1[((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 512)) + ((((((int)threadIdx.y) * 8) + ((int)threadIdx.x)) >> 4) * 256)) + (rc_outer * 16)) + (((((int)threadIdx.y) * 8) + ((int)threadIdx.x)) & 15)))];
          }
        }
      }
    }
  ...
  T_relu[((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)))] = max((compute[(0)] + placeholder2[(((((int)task_idx.z) * 32) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[(((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + 12544))] = max((compute[(2)] + placeholder2[((((((int)task_idx.z) * 32) + ((int)threadIdx.z)) + 16))]), 0.000000e+00f);
  T_relu[(((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + 1))] = max((compute[(1)] + placeholder2[(((((int)task_idx.z) * 32) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[(((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + 12545))] = max((compute[(3)] + placeholder2[((((((int)task_idx.z) * 32) + ((int)threadIdx.z)) + 16))]), 0.000000e+00f);
}
...
__device__  void fused_nn_global_avg_pool2d_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ tensor){
  ...
  for (int rv0 = 0; rv0 < 7; ++rv0) {
    for (int rv1 = 0; rv1 < 7; ++rv1) {
      if (((int)threadIdx.y) < 1) {
        tensor1[(0)] = (tensor1[(0)] + placeholder[((((((((int)threadIdx.y) * 50176) + (((int)task_idx.x) * 392)) + (((int)threadIdx.x) * 49)) + (rv0 * 7)) + rv1))]);
      }
    }
  }
  if (((int)threadIdx.y) < 1) {
    tensor[((((((int)threadIdx.y) * 1024) + (((int)task_idx.x) * 8)) + ((int)threadIdx.x)))] = (tensor1[(0)] * 2.040816e-02f);
  }
}
...
__device__  void fused_nn_conv2d_add_nn_relu_9_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  PaddedInput_shared[((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))] = (((((1 <= ((((int)task_idx.y) * 14) + (((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) & 255) >> 4))) && (((((int)task_idx.y) * 14) + (((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) & 255) >> 4)) < 29)) && (1 <= ((((int)task_idx.x) * 14) + ((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) & 15)))) && (((((int)task_idx.x) * 14) + ((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) & 15)) < 29)) ? placeholder[((((((((((int)task_idx.z) * 3136) + (((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) >> 8) * 784)) + (((int)task_idx.y) * 392)) + ((((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) & 255) >> 4) * 28)) + (((int)task_idx.x) * 14)) + ((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) & 15)) - 29))] : 0.000000e+00f);
  PaddedInput_shared[(((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 392))] = (((((1 <= ((((int)task_idx.y) * 14) + ((((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 136) & 255) >> 4))) && (((((int)task_idx.y) * 14) + ((((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 136) & 255) >> 4)) < 29)) && (1 <= ((((int)task_idx.x) * 14) + (((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 8) & 15)))) && (((((int)task_idx.x) * 14) + (((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 8) & 15)) < 29)) ? placeholder[((((((((((int)task_idx.z) * 3136) + ((((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 392) >> 8) * 784)) + (((int)task_idx.y) * 392)) + (((((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 136) & 255) >> 4) * 28)) + (((int)task_idx.x) * 14)) + (((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 8) & 15)) - 29))] : 0.000000e+00f);
  if ((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) < 240) {
    if (((((int)threadIdx.z) * 14) + ((int)threadIdx.y)) < 35) {
      if (((int)threadIdx.z) < 3) {
        PaddedInput_shared[(((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 784))] = ((((((((int)task_idx.y) * 14) + (((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 16) >> 4)) < 29) && (1 <= ((((int)task_idx.x) * 14) + ((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) & 15)))) && (((((int)task_idx.x) * 14) + ((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) & 15)) < 29)) ? placeholder[((((((((((int)task_idx.z) * 3136) + ((((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 784) >> 8) * 784)) + (((int)task_idx.y) * 392)) + ((((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 16) >> 4) * 28)) + (((int)task_idx.x) * 14)) + ((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) & 15)) - 29))] : 0.000000e+00f);
      }
    }
  }
  if ((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) < 36) {
    if (((((int)threadIdx.z) * 14) + ((int)threadIdx.y)) < 6) {
      if (((int)threadIdx.z) < 1) {
        placeholder_shared[((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))] = placeholder1[(((((((int)threadIdx.z) * 98) + (((int)task_idx.z) * 36)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))];
      }
    }
  }
  __syncthreads();
  ...
  DepthwiseConv2d[(1)] = __ocml_fma_f32(PaddedInput_shared_local[(10)], placeholder_shared_local[(7)], DepthwiseConv2d[(1)]);
  DepthwiseConv2d[(1)] = __ocml_fma_f32(PaddedInput_shared_local[(11)], placeholder_shared_local[(8)], DepthwiseConv2d[(1)]);
  T_relu[(((((((((int)task_idx.z) * 3136) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 392)) + (((int)threadIdx.y) * 28)) + (((int)task_idx.x) * 14)) + (((int)threadIdx.x) * 2)))] = max((DepthwiseConv2d[(0)] + placeholder2[(((((int)task_idx.z) * 4) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 3136) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 392)) + (((int)threadIdx.y) * 28)) + (((int)task_idx.x) * 14)) + (((int)threadIdx.x) * 2)) + 1))] = max((DepthwiseConv2d[(1)] + placeholder2[(((((int)task_idx.z) * 4) + ((int)threadIdx.z)))]), 0.000000e+00f);
}
...
__device__  void fused_nn_dense_add_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  ...
  for (int k_outer = 0; k_outer < 16; ++k_outer) {
    T_dense_rf[(0)] = __ocml_fma_f32(placeholder[(((k_outer * 64) + ((int)threadIdx.x)))], placeholder1[((((((int)task_idx.x) * 1024) + (k_outer * 64)) + ((int)threadIdx.x)))], T_dense_rf[(0)]);
  }
  unsigned int mask[1];
  float t0[1];
...
__device__  void fused_nn_conv2d_add_nn_relu_15_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  for (int ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer = 0; ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer < 5; ++ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer) {
    if ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer * 784) + (((int)threadIdx.y) * 56)) + ((int)threadIdx.x)) < 3277) {
      if (((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer * 14) + ((int)threadIdx.y)) < 59) {
        PaddedInput_shared[((((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer * 784) + (((int)threadIdx.y) * 56)) + ((int)threadIdx.x)))] = (((1 <= ((((int)task_idx.y) * 28) + ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer * 784) + (((int)threadIdx.y) * 56)) + ((int)threadIdx.x)) / 113))) && (1 <= ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer * 784) + (((int)threadIdx.y) * 56)) + ((int)threadIdx.x)) % 113))) ? placeholder[((((((((int)task_idx.z) * 12544) + (((int)task_idx.y) * 3136)) + (((((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer * 784) + (((int)threadIdx.y) * 56)) + ((int)threadIdx.x)) / 113) * 112)) + ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer * 784) + (((int)threadIdx.y) * 56)) + ((int)threadIdx.x)) % 113)) - 113))] : 0.000000e+00f);
      }
    }
  }
  if (((((int)threadIdx.y) * 56) + ((int)threadIdx.x)) < 9) {
    if (((int)threadIdx.y) < 1) {
      placeholder_shared[(((((int)threadIdx.y) * 56) + ((int)threadIdx.x)))] = placeholder1[((((((int)threadIdx.y) * 56) + (((int)task_idx.z) * 9)) + ((int)threadIdx.x)))];
    }
  }
  __syncthreads();
  for (int ax2 = 0; ax2 < 3; ++ax2) {
  ...
  T_relu[(((((((int)task_idx.z) * 3136) + (((int)task_idx.y) * 784)) + (((int)threadIdx.y) * 56)) + ((int)threadIdx.x)))] = max((DepthwiseConv2d[(0)] + placeholder2[(((int)task_idx.z))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_nn_relu_3_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  if ((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) < 72) {
    if (((((int)threadIdx.z) * 7) + ((int)threadIdx.y)) < 11) {
      if (((int)threadIdx.z) < 2) {
        placeholder_shared[((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))] = placeholder1[(((((((int)task_idx.z) * 72) + (((int)threadIdx.z) * 49)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))];
      }
    }
  }
  __syncthreads();
  ...
  DepthwiseConv2d[(0)] = __ocml_fma_f32(PaddedInput_shared_local[(7)], placeholder_shared_local[(7)], DepthwiseConv2d[(0)]);
  DepthwiseConv2d[(0)] = __ocml_fma_f32(PaddedInput_shared_local[(8)], placeholder_shared_local[(8)], DepthwiseConv2d[(0)]);
  T_relu[(((((((int)task_idx.z) * 392) + (((int)threadIdx.z) * 49)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))] = max((DepthwiseConv2d[(0)] + placeholder2[(((((int)task_idx.z) * 8) + ((int)threadIdx.z)))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_nn_relu_4_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  for (int rc_outer = 0; rc_outer < 32; ++rc_outer) {
    __syncthreads();
    pad_temp_shared[((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)))] = placeholder[((((((((rc_outer * 3136) + (((int)threadIdx.z) * 392)) + ((((((int)threadIdx.y) * 2) + ((((int)threadIdx.x) * 2) / 7)) / 7) * 196)) + (((int)task_idx.y) * 98)) + ((((((int)threadIdx.y) * 2) + ((((int)threadIdx.x) * 2) / 7)) % 7) * 14)) + (((int)task_idx.x) * 7)) + ((((int)threadIdx.x) * 2) % 7)))];
    pad_temp_shared[(((((((int)threadIdx.z) * 98) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder[((((((((rc_outer * 3136) + (((int)threadIdx.z) * 392)) + ((((((int)threadIdx.y) * 2) + (((((int)threadIdx.x) * 2) + 1) / 7)) / 7) * 196)) + (((int)task_idx.y) * 98)) + ((((((int)threadIdx.y) * 2) + (((((int)threadIdx.x) * 2) + 1) / 7)) % 7) * 14)) + (((int)task_idx.x) * 7)) + (((((int)threadIdx.x) * 2) + 1) % 7)))];
  ...
  T_relu[(((((((((int)task_idx.z) * 3136) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)task_idx.x) * 7)) + ((int)threadIdx.x)))] = max((compute[(0)] + placeholder2[(((((int)task_idx.z) * 16) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((((int)task_idx.z) * 3136) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)task_idx.x) * 7)) + ((int)threadIdx.x)) + 1568))] = max((compute[(1)] + placeholder2[((((((int)task_idx.z) * 16) + ((int)threadIdx.z)) + 8))]), 0.000000e+00f);
}
  ...
  for (int rc_outer = 0; rc_outer < 32; ++rc_outer) {
    ...
    if (((((((int)threadIdx.y) * 5) + ((int)threadIdx.x)) >> 5) + ((int)threadIdx.z)) < 16) {
      if ((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 5)) + ((int)threadIdx.x)) < 512) {
        if (((((int)threadIdx.y) * 5) + ((int)threadIdx.x)) < 32) {
          if (((int)threadIdx.x) < 5) {
            placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 5)) + ((int)threadIdx.x)))] = placeholder1[((((((((int)task_idx.z) * 16384) + (((int)threadIdx.z) * 1024)) + (rc_outer * 32)) + (((int)threadIdx.y) * 5)) + ((int)threadIdx.x)))];
          }
        }
      }
    }
...
__device__  void fused_nn_conv2d_add_nn_relu_1_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  float placeholder_shared_local[9];
  float DepthwiseConv2d[1];
  PaddedInput_shared[((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))] = (((((9 <= ((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) % 81)) && (((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) % 81) < 72)) && (1 <= ((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) % 9))) && (((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) % 9) < 8)) ? placeholder[((((((((int)task_idx.z) * 196) + (((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) / 81) * 49)) + ((((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) % 81) / 9) * 7)) + ((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) % 9)) - 8))] : 0.000000e+00f);
  if ((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) < 128) {
    if (((((int)threadIdx.z) * 7) + ((int)threadIdx.y)) < 19) {
      if (((int)threadIdx.z) < 3) {
        PaddedInput_shared[(((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 196))] = (((((9 <= (((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 34) % 81)) && ((((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 34) % 81) < 72)) && (1 <= (((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 7) % 9))) && ((((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 7) % 9) < 8)) ? placeholder[((((((((int)task_idx.z) * 196) + ((((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 196) / 81) * 49)) + (((((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 34) % 81) / 9) * 7)) + (((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) + 7) % 9)) - 8))] : 0.000000e+00f);
      }
    }
  }
  if ((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)) < 36) {
    if (((((int)threadIdx.z) * 7) + ((int)threadIdx.y)) < 6) {
      if (((int)threadIdx.z) < 1) {
        placeholder_shared[((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))] = placeholder1[(((((((int)threadIdx.z) * 49) + (((int)task_idx.z) * 36)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))];
      }
    }
  }
  __syncthreads();
  ...
  DepthwiseConv2d[(0)] = __ocml_fma_f32(PaddedInput_shared_local[(7)], placeholder_shared_local[(7)], DepthwiseConv2d[(0)]);
  DepthwiseConv2d[(0)] = __ocml_fma_f32(PaddedInput_shared_local[(8)], placeholder_shared_local[(8)], DepthwiseConv2d[(0)]);
  T_relu[(((((((int)task_idx.z) * 196) + (((int)threadIdx.z) * 49)) + (((int)threadIdx.y) * 7)) + ((int)threadIdx.x)))] = max((DepthwiseConv2d[(0)] + placeholder2[(((((int)task_idx.z) * 4) + ((int)threadIdx.z)))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_nn_relu_5_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  DepthwiseConv2d[(1)] = __ocml_fma_f32(PaddedInput_shared_local[(10)], placeholder_shared_local[(7)], DepthwiseConv2d[(1)]);
  DepthwiseConv2d[(1)] = __ocml_fma_f32(PaddedInput_shared_local[(11)], placeholder_shared_local[(8)], DepthwiseConv2d[(1)]);
  T_relu[(((((((int)task_idx.z) * 392) + (((int)threadIdx.z) * 196)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)))] = max((DepthwiseConv2d[(0)] + placeholder2[(((((int)task_idx.z) * 2) + ((int)threadIdx.z)))]), 0.000000e+00f);
  T_relu[((((((((int)task_idx.z) * 392) + (((int)threadIdx.z) * 196)) + (((int)threadIdx.y) * 14)) + (((int)threadIdx.x) * 2)) + 1))] = max((DepthwiseConv2d[(1)] + placeholder2[(((((int)task_idx.z) * 2) + ((int)threadIdx.z)))]), 0.000000e+00f);
}
  ...
  for (int rc_outer = 0; rc_outer < 8; ++rc_outer) {
    ...
    if (((((int)threadIdx.z) * 2) + (((((int)threadIdx.y) * 8) + ((int)threadIdx.x)) >> 4)) < 32) {
      if ((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 8)) + ((int)threadIdx.x)) < 512) {
        if (((((int)threadIdx.y) * 8) + ((int)threadIdx.x)) < 32) {
          if (((int)threadIdx.x) < 8) {
            placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 8)) + ((int)threadIdx.x)))] = placeholder1[((((((((int)task_idx.z) * 4096) + (((int)threadIdx.z) * 256)) + ((((((int)threadIdx.y) * 8) + ((int)threadIdx.x)) >> 4) * 128)) + (rc_outer * 16)) + (((((int)threadIdx.y) * 8) + ((int)threadIdx.x)) & 15)))];
          }
        }
      }
    }
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_14_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(7,14,2);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        fused_nn_conv2d_add_nn_relu_14_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void fused_nn_conv2d_add_nn_relu_18_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(7,16,1);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        if (*preempted) return;
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        fused_nn_conv2d_add_nn_relu_18_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void fused_nn_conv2d_add_nn_relu_17_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(1,8,32);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        if (*preempted) return;
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        fused_nn_conv2d_add_nn_relu_17_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_16_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(7,28,1);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        if (*preempted) return;
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        fused_nn_conv2d_add_nn_relu_16_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_13_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(1,1,128);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        fused_nn_conv2d_add_nn_relu_13_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}
...
extern "C" __global__ void fused_nn_conv2d_add_nn_relu_15_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(1,4,64);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        if (*preempted) return;
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        fused_nn_conv2d_add_nn_relu_15_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}
