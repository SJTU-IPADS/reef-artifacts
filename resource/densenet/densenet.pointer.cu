...
__device__ __noinline__ void fused_nn_avg_pool2d_add_nn_relu_kernel0_device(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1){
  float tensor[1];
...
__device__ __noinline__ void fused_nn_avg_pool2d_add_nn_relu_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1){
  float tensor[1];
  tensor[(0)] = 0.000000e+00f;
  for (int dh = 0; dh < 2; ++dh) {
    for (int dw = 0; dw < 2; ++dw) {
...
__device__ __noinline__ void fused_nn_avg_pool2d_add_nn_relu_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1){
  float tensor[1];
  tensor[(0)] = 0.000000e+00f;
  for (int dh = 0; dh < 2; ++dh) {
    for (int dw = 0; dw < 2; ++dw) {
...
__device__ __noinline__ void fused_nn_avg_pool2d_kernel0_device(float* __restrict__ placeholder, float* __restrict__ tensor){
  float tensor1[1];
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_avg_pool2d_add_nn_relu_kernel0(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_avg_pool2d_add_nn_relu_1_kernel0(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_avg_pool2d_add_nn_relu_2_kernel0(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1) {
    fused_nn_avg_pool2d_add_nn_relu_2_kernel0_device(placeholder, T_relu, placeholder1);
}

extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_avg_pool2d_kernel0(float* __restrict__ placeholder, float* __restrict__ tensor) {
...
extern "C" __global__ void _get_func_pointers(unsigned long long int *address) {
    address[0] = (unsigned long long int)&fused_nn_avg_pool2d_add_nn_relu_1_kernel0_device;
    address[1] = (unsigned long long int)&fused_nn_avg_pool2d_add_nn_relu_2_kernel0_device;
    address[2] = (unsigned long long int)&fused_nn_avg_pool2d_add_nn_relu_kernel0_device;
    address[3] = (unsigned long long int)&fused_nn_avg_pool2d_kernel0_device;
    address[4] = (unsigned long long int)&fused_nn_batch_flatten_kernel0_device;
    address[5] = (unsigned long long int)&fused_nn_conv2d_1_kernel0_device;
    address[6] = (unsigned long long int)&fused_nn_conv2d_2_kernel0_device;
    address[7] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_10_kernel0_device;
    address[8] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_11_kernel0_device;
    address[9] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_12_kernel0_device;
    ...
    address[20] = (unsigned long long int)&fused_nn_conv2d_kernel0_device;
    address[21] = (unsigned long long int)&fused_nn_dense_add_kernel0_device;
    address[22] = (unsigned long long int)&fused_nn_max_pool2d_add_nn_relu_kernel0_device;
