...
__device__  void fused_nn_conv2d_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
    ...
    if ((((((int)threadIdx.z) * 7) + ((int)threadIdx.x)) + ((int)threadIdx.y)) < 49) {
      if ((((int)threadIdx.x) + ((int)threadIdx.y)) < 7) {
        if (((int)threadIdx.x) < 1) {
          pad_temp_shared[((((((int)threadIdx.z) * 7) + ((int)threadIdx.x)) + ((int)threadIdx.y)))] = placeholder[((((((((((int)threadIdx.z) / 7) * 196) + (((int)task_idx.y) * 98)) + ((((int)threadIdx.z) % 7) * 14)) + (((int)task_idx.x) * 7)) + ((int)threadIdx.x)) + ((int)threadIdx.y)))];
        }
      }
    }
  }
  if ((((((int)threadIdx.z) * 2) + ((int)threadIdx.x)) + ((int)threadIdx.y)) < 16) {
    if ((((int)threadIdx.x) + ((int)threadIdx.y)) < 2) {
      if (((int)threadIdx.x) < 1) {
        placeholder_shared[((((((int)threadIdx.z) * 2) + ((int)threadIdx.x)) + ((int)threadIdx.y)))] = placeholder1[(((((((int)task_idx.z) * 16) + (((int)threadIdx.z) * 2)) + ((int)threadIdx.x)) + ((int)threadIdx.y)))];
      }
    }
  }
  __syncthreads();
  ...
  compute[(((((((((int)task_idx.z) * 3136) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)task_idx.x) * 7)) + ((int)threadIdx.x)))] = compute_local[(0)];
  compute[((((((((((int)task_idx.z) * 3136) + (((int)threadIdx.z) * 196)) + (((int)task_idx.y) * 98)) + (((int)threadIdx.y) * 14)) + (((int)task_idx.x) * 7)) + ((int)threadIdx.x)) + 1568))] = compute_local[(1)];
}
...
__device__  void fused_nn_conv2d_add_nn_relu_8_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  T_relu[(((((((int)threadIdx.z) * 784) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)))] = max((compute[(0)] + placeholder2[(((int)threadIdx.z))]), 0.000000e+00f);
  T_relu[((((((((int)threadIdx.z) * 784) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + 12544))] = max((compute[(2)] + placeholder2[((((int)threadIdx.z) + 16))]), 0.000000e+00f);
  T_relu[((((((((int)threadIdx.z) * 784) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + 1))] = max((compute[(1)] + placeholder2[(((int)threadIdx.z))]), 0.000000e+00f);
  T_relu[((((((((int)threadIdx.z) * 784) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + 12545))] = max((compute[(3)] + placeholder2[((((int)threadIdx.z) + 16))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_nn_relu_3_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  for (int rc_outer = 0; rc_outer < 4; ++rc_outer) {
    ...
    for (int ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner = 0; ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner < 32; ++ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) {
      pad_temp_shared[((((((int)threadIdx.y) * 64) + (((int)threadIdx.x) * 32)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner))] = (((((1 <= ((((int)task_idx.y) * 2) + ((ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner & 15) >> 2))) && (((((int)task_idx.y) * 2) + ((ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner & 15) >> 2)) < 15)) && (1 <= ((((int)task_idx.x) * 2) + (ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner & 3)))) && (((((int)task_idx.x) * 2) + (ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner & 3)) < 15)) ? placeholder[((((((((((rc_outer * 1568) + (((int)threadIdx.y) * 784)) + (((int)threadIdx.x) * 392)) + ((ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner >> 4) * 196)) + (((int)task_idx.y) * 28)) + (((ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner & 15) >> 2) * 14)) + (((int)task_idx.x) * 2)) + (ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner & 3)) - 15))] : 0.000000e+00f);
    }
  ...
  T_relu[(((((((int)task_idx.y) * 28) + (((int)threadIdx.y) * 14)) + (((int)task_idx.x) * 2)) + ((int)threadIdx.x)))] = max((compute[(0)] + placeholder2[(0)]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_add_nn_relu_10_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  if (((((int)threadIdx.x) + ((int)threadIdx.y)) + ((int)threadIdx.z)) < 32) {
    if ((((int)threadIdx.x) + ((int)threadIdx.y)) < 1) {
      if (((int)threadIdx.x) < 1) {
        pad_temp_shared[(((((int)threadIdx.x) + ((int)threadIdx.y)) + ((int)threadIdx.z)))] = placeholder[(((((((int)task_idx.y) * 224) + ((((((int)threadIdx.x) + ((int)threadIdx.y)) + ((int)threadIdx.z)) >> 3) * 56)) + (((int)task_idx.x) * 8)) + (((((int)threadIdx.x) + ((int)threadIdx.y)) + ((int)threadIdx.z)) & 7)))];
      }
    }
  }
  if (((((int)threadIdx.x) + ((int)threadIdx.y)) + ((int)threadIdx.z)) < 32) {
  ...
  T_relu[((((((((int)threadIdx.z) * 3136) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)))] = max((compute[(0)] + placeholder2[(((int)threadIdx.z))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 3136) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 112))] = max((compute[(2)] + placeholder2[(((int)threadIdx.z))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 3136) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = max((compute[(1)] + placeholder2[(((int)threadIdx.z))]), 0.000000e+00f);
  T_relu[(((((((((int)threadIdx.z) * 3136) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 113))] = max((compute[(3)] + placeholder2[(((int)threadIdx.z))]), 0.000000e+00f);
}
  ...
  if ((((((int)threadIdx.z) * 7) + (((int)threadIdx.y) * 2)) + ((int)threadIdx.x)) < 112) {
    if (((((int)threadIdx.y) * 2) + ((int)threadIdx.x)) < 7) {
      if (((int)threadIdx.x) < 2) {
        pad_temp_shared[((((((int)threadIdx.z) * 7) + (((int)threadIdx.y) * 2)) + ((int)threadIdx.x)))] = placeholder[(((((((int)task_idx.y) * 112) + (((int)threadIdx.z) * 7)) + (((int)threadIdx.y) * 2)) + ((int)threadIdx.x)))];
      }
    }
  }
...
__device__  void fused_nn_conv2d_1_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
  ...
  if ((((((int)threadIdx.z) * 2) + ((int)threadIdx.x)) + ((int)threadIdx.y)) < 32) {
    if ((((int)threadIdx.x) + ((int)threadIdx.y)) < 2) {
      if (((int)threadIdx.x) < 1) {
        placeholder_shared[((((((int)threadIdx.z) * 2) + ((int)threadIdx.x)) + ((int)threadIdx.y)))] = placeholder1[(((((((int)task_idx.z) * 32) + (((int)threadIdx.z) * 2)) + ((int)threadIdx.x)) + ((int)threadIdx.y)))];
      }
    }
  }
  __syncthreads();
  ...
  compute[((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)))] = compute_local[(0)];
  compute[(((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + 12544))] = compute_local[(2)];
  compute[(((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + 1))] = compute_local[(1)];
  compute[(((((((((int)task_idx.z) * 25088) + (((int)threadIdx.z) * 784)) + (((int)task_idx.y) * 112)) + (((int)threadIdx.y) * 28)) + (((int)threadIdx.x) * 2)) + 12545))] = compute_local[(3)];
}
...
__device__  void fused_nn_conv2d_add_nn_relu_11_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  compute[(1)] = 0.000000e+00f;
  compute[(3)] = 0.000000e+00f;
  pad_temp_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)))] = placeholder[(((((((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) >> 2) * 3136) + (((int)task_idx.y) * 224)) + ((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) & 3) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)))];
  pad_temp_shared[(((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder[((((((((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) >> 2) * 3136) + (((int)task_idx.y) * 224)) + ((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) & 3) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 1))];
  ...
  __syncthreads();
  pad_temp_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)))] = placeholder[((((((((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) >> 2) * 3136) + (((int)task_idx.y) * 224)) + ((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) & 3) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50176))];
  pad_temp_shared[(((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder[((((((((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) >> 2) * 3136) + (((int)task_idx.y) * 224)) + ((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) & 3) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 50177))];
  ...
  compute[(3)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)) + 497))], placeholder_shared[(((((int)threadIdx.z) * 16) + 15))], compute[(3)]);
  __syncthreads();
  pad_temp_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)))] = placeholder[((((((((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) >> 2) * 3136) + (((int)task_idx.y) * 224)) + ((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) & 3) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100352))];
  pad_temp_shared[(((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder[((((((((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) >> 2) * 3136) + (((int)task_idx.y) * 224)) + ((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) & 3) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100353))];
  ...
  compute[(3)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)) + 497))], placeholder_shared[(((((int)threadIdx.z) * 16) + 15))], compute[(3)]);
  __syncthreads();
  pad_temp_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)))] = placeholder[((((((((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) >> 2) * 3136) + (((int)task_idx.y) * 224)) + ((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) & 3) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 150528))];
  pad_temp_shared[(((((((int)threadIdx.z) * 16) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + 1))] = placeholder[((((((((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) >> 2) * 3136) + (((int)task_idx.y) * 224)) + ((((((int)threadIdx.z) * 2) + ((int)threadIdx.y)) & 3) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 150529))];
...
__device__  void fused_nn_dense_add_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  ...
  if (((int)threadIdx.x) < 1) {
    T_dense_rf[(0)] = __ocml_fma_f32(placeholder[(((int)threadIdx.x))], placeholder1[((((int)task_idx.x) + ((int)threadIdx.x)))], T_dense_rf[(0)]);
  }
  unsigned int mask[1];
  float t0[1];
...
__device__  void fused_nn_avg_pool2d_add_nn_relu_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1){
  float tensor[1];
  tensor[(0)] = 0.000000e+00f;
  for (int dh = 0; dh < 2; ++dh) {
    for (int dw = 0; dw < 2; ++dw) {
      if (((((int)task_idx.x) * 256) + ((int)threadIdx.x)) < 43904) {
        tensor[(0)] = (tensor[(0)] + placeholder[((((((((((int)task_idx.x) * 256) + ((int)threadIdx.x)) / 7) * 28) + (dh * 14)) + ((((((int)task_idx.x) * 256) + ((int)threadIdx.x)) % 7) * 2)) + dw))]);
      }
    }
  }
  if (((((int)task_idx.x) * 256) + ((int)threadIdx.x)) < 43904) {
    T_relu[(((((int)task_idx.x) * 256) + ((int)threadIdx.x)))] = max(__ocml_fma_f32(tensor[(0)], 2.500000e-01f, placeholder1[((((((int)task_idx.x) * 256) + ((int)threadIdx.x)) / 49))]), 0.000000e+00f);
  }
}
...
__device__  void fused_nn_conv2d_add_nn_relu_9_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
      ...
      if (((((int)threadIdx.y) * 5) + (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) / 9)) < 40) {
        if ((((((int)threadIdx.y) * 45) + (((int)threadIdx.x) * 7)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) < 360) {
          if (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) < 45) {
            pad_temp_shared[((((((int)threadIdx.y) * 45) + (((int)threadIdx.x) * 7)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner))] = (((((1 <= ((((int)task_idx.y) * 8) + (((((int)threadIdx.y) * 5) + (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) / 9)) % 10))) && (((((int)task_idx.y) * 8) + (((((int)threadIdx.y) * 5) + (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) / 9)) % 10)) < 57)) && (1 <= ((((int)task_idx.x) * 7) + (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) % 9)))) && (((((int)task_idx.x) * 7) + (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) % 9)) < 57)) ? placeholder[((((((((rc_outer * 12544) + ((((((int)threadIdx.y) * 5) + (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) / 9)) / 10) * 3136)) + (((int)task_idx.y) * 448)) + ((((((int)threadIdx.y) * 5) + (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) / 9)) % 10) * 56)) + (((int)task_idx.x) * 7)) + (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) % 9)) - 57))] : 0.000000e+00f);
          }
        }
      }
    }
  ...
  T_relu[(((((((int)task_idx.y) * 448) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 7)) + ((int)threadIdx.x)))] = max((compute[(0)] + placeholder2[(0)]), 0.000000e+00f);
}

__device__  void fused_nn_avg_pool2d_add_nn_relu_1_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1){
  float tensor[1];
  tensor[(0)] = 0.000000e+00f;
  for (int dh = 0; dh < 2; ++dh) {
    for (int dw = 0; dw < 2; ++dw) {
      tensor[(0)] = (tensor[(0)] + placeholder[((((((((((int)task_idx.x) * 256) + ((int)threadIdx.x)) / 14) * 56) + (dh * 28)) + ((((((int)task_idx.x) * 256) + ((int)threadIdx.x)) % 14) * 2)) + dw))]);
    }
  }
  T_relu[(((((int)task_idx.x) * 256) + ((int)threadIdx.x)))] = max(__ocml_fma_f32(tensor[(0)], 2.500000e-01f, placeholder1[((((((int)task_idx.x) * 256) + ((int)threadIdx.x)) / 196))]), 0.000000e+00f);
}
    ...
    if (((((int)threadIdx.z) * 2) + (((((int)threadIdx.y) * 5) + ((int)threadIdx.x)) >> 4)) < 16) {
      if ((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 5)) + ((int)threadIdx.x)) < 256) {
        if (((((int)threadIdx.y) * 5) + ((int)threadIdx.x)) < 32) {
          if (((int)threadIdx.x) < 5) {
            placeholder_shared[((((((int)threadIdx.z) * 32) + (((int)threadIdx.y) * 5)) + ((int)threadIdx.x)))] = placeholder1[((((((((int)task_idx.z) * 4096) + (((int)threadIdx.z) * 512)) + ((((((int)threadIdx.y) * 5) + ((int)threadIdx.x)) >> 4) * 256)) + (rc_outer * 16)) + (((((int)threadIdx.y) * 5) + ((int)threadIdx.x)) & 15)))];
          }
        }
      }
    }
...
__device__  void fused_nn_conv2d_add_nn_relu_1_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  if (((((int)threadIdx.x) + ((int)threadIdx.y)) + ((int)threadIdx.z)) < 16) {
    if ((((int)threadIdx.x) + ((int)threadIdx.y)) < 1) {
      if (((int)threadIdx.x) < 1) {
        placeholder_shared[(((((int)threadIdx.x) + ((int)threadIdx.y)) + ((int)threadIdx.z)))] = placeholder1[(((((((int)task_idx.z) * 16) + ((int)threadIdx.x)) + ((int)threadIdx.y)) + ((int)threadIdx.z)))];
      }
    }
  }
  __syncthreads();
...
__device__  void fused_nn_conv2d_add_nn_relu_2_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  for (int rc_outer = 0; rc_outer < 32; ++rc_outer) {
    __syncthreads();
    for (int ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner = 0; ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner < 7; ++ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) {
      pad_temp_shared[((((((int)threadIdx.z) * 49) + (((int)threadIdx.x) * 7)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner))] = placeholder[((((((rc_outer * 1372) + (((int)threadIdx.z) * 343)) + (((int)threadIdx.x) * 49)) + (((int)task_idx.y) * 7)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner))];
    }
    for (int ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1 = 0; ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1 < 4; ++ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1) {
      placeholder_shared[((((((int)threadIdx.z) * 28) + (((int)threadIdx.x) * 4)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1))] = placeholder1[((((((((int)task_idx.z) * 3584) + (((int)threadIdx.z) * 896)) + (rc_outer * 28)) + (((int)threadIdx.x) * 4)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1))];
    }
    __syncthreads();
  ...
  T_relu[(((((((int)task_idx.z) * 196) + (((int)threadIdx.z) * 49)) + (((int)task_idx.y) * 7)) + ((int)threadIdx.x)))] = max((compute[(0)] + placeholder2[(((((int)task_idx.z) * 4) + ((int)threadIdx.z)))]), 0.000000e+00f);
}
...
__device__  void fused_nn_conv2d_2_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
  ...
  if ((((((int)threadIdx.z) * 2) + ((int)threadIdx.x)) + ((int)threadIdx.y)) < 64) {
    if ((((int)threadIdx.x) + ((int)threadIdx.y)) < 2) {
      if (((int)threadIdx.x) < 1) {
        placeholder_shared[((((((int)threadIdx.z) * 2) + ((int)threadIdx.x)) + ((int)threadIdx.y)))] = placeholder1[(((((((int)task_idx.z) * 64) + (((int)threadIdx.z) * 2)) + ((int)threadIdx.x)) + ((int)threadIdx.y)))];
      }
    }
  }
  __syncthreads();
  ...
  compute[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 112))] = compute_local[(2)];
  compute[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100464))] = compute_local[(6)];
  ...
  compute[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 113))] = compute_local[(3)];
  compute[((((((((((int)task_idx.z) * 200704) + (((int)threadIdx.z) * 3136)) + (((int)task_idx.y) * 224)) + (((int)threadIdx.y) * 56)) + (((int)task_idx.x) * 8)) + (((int)threadIdx.x) * 2)) + 100465))] = compute_local[(7)];
}
...
__device__  void fused_nn_conv2d_add_nn_relu_12_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
    ...
    for (int ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner = 0; ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner < 2; ++ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) {
      if (((((((int)threadIdx.z) * 121) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) < 481) {
        if ((((((int)threadIdx.y) * 8) + (((int)threadIdx.x) * 2)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) < 121) {
          pad_temp_shared[(((((((int)threadIdx.z) * 121) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner))] = (((((3 <= ((((int)task_idx.y) * 32) + (((((((int)threadIdx.z) * 121) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) / 13))) && (((((int)task_idx.y) * 32) + (((((((int)threadIdx.z) * 121) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) / 13)) < 227)) && (3 <= ((((int)task_idx.x) * 8) + (((((((int)threadIdx.z) * 121) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) % 13)))) && (((((int)task_idx.x) * 8) + (((((((int)threadIdx.z) * 121) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) % 13)) < 227)) ? placeholder[(((((((rc_outer * 50176) + (((int)task_idx.y) * 7168)) + ((((((((int)threadIdx.z) * 121) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) / 13) * 224)) + (((int)task_idx.x) * 8)) + (((((((int)threadIdx.z) * 121) + (((int)threadIdx.y) * 8)) + (((int)threadIdx.x) * 2)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) % 13)) - 675))] : 0.000000e+00f);
        }
      }
    }
      ...
      if (((((int)threadIdx.z) * 7) + (((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) / 7)) < 28) {
        if ((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 4)) + ((int)threadIdx.x)) < 196) {
          if (((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) < 49) {
            placeholder_shared[((((((int)threadIdx.z) * 49) + (((int)threadIdx.y) * 4)) + ((int)threadIdx.x)))] = placeholder1[((((((((int)task_idx.z) * 588) + (((int)threadIdx.z) * 147)) + (rc_outer * 49)) + (((int)threadIdx.y) * 4)) + ((int)threadIdx.x)))];
          }
        }
      }
    }
  ...
  T_relu[(((((((((int)task_idx.z) * 50176) + (((int)threadIdx.z) * 12544)) + (((int)task_idx.y) * 1792)) + (((int)threadIdx.y) * 112)) + (((int)task_idx.x) * 4)) + ((int)threadIdx.x)))] = max((compute[(0)] + placeholder2[(((((int)task_idx.z) * 4) + ((int)threadIdx.z)))]), 0.000000e+00f);
}

__device__  void fused_nn_avg_pool2d_add_nn_relu_2_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1){
  float tensor[1];
  tensor[(0)] = 0.000000e+00f;
  for (int dh = 0; dh < 2; ++dh) {
    for (int dw = 0; dw < 2; ++dw) {
      tensor[(0)] = (tensor[(0)] + placeholder[((((((((((int)task_idx.x) * 256) + ((int)threadIdx.x)) / 28) * 112) + (dh * 56)) + ((((((int)task_idx.x) * 256) + ((int)threadIdx.x)) % 28) * 2)) + dw))]);
    }
  }
  T_relu[(((((int)task_idx.x) * 256) + ((int)threadIdx.x)))] = max(__ocml_fma_f32(tensor[(0)], 2.500000e-01f, placeholder1[((((((int)task_idx.x) * 256) + ((int)threadIdx.x)) / 784))]), 0.000000e+00f);
}

__device__  void fused_nn_avg_pool2d_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ tensor){
  float tensor1[1];
...
__device__  void fused_nn_conv2d_add_nn_relu_6_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
        ...
        if (((((int)threadIdx.y) * 6) + (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) >> 4)) < 24) {
          if ((((((int)threadIdx.y) * 96) + (((int)threadIdx.x) * 7)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) < 384) {
            if (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) < 96) {
              pad_temp_shared[((((((int)threadIdx.y) * 96) + (((int)threadIdx.x) * 7)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner))] = (((((1 <= ((((int)task_idx.y) * 4) + (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) >> 4))) && (((((int)task_idx.y) * 4) + (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) >> 4)) < 29)) && (1 <= ((((int)task_idx.x) * 14) + (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) & 15)))) && (((((int)task_idx.x) * 14) + (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) & 15)) < 29)) ? placeholder[((((((((rc_outer * 3136) + (((int)threadIdx.y) * 784)) + (((int)task_idx.y) * 112)) + ((((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) >> 4) * 28)) + (((int)task_idx.x) * 14)) + (((((int)threadIdx.x) * 7) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) & 15)) - 29))] : 0.000000e+00f);
            }
          }
        }
      }
  ...
  T_relu[(((((((int)task_idx.y) * 112) + (((int)threadIdx.y) * 28)) + (((int)task_idx.x) * 14)) + ((int)threadIdx.x)))] = max((compute[(0)] + placeholder2[(0)]), 0.000000e+00f);
}
...
extern "C" __global__ void fused_nn_avg_pool2d_add_nn_relu_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(172,1,1);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        if (*preempted) return;
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        fused_nn_avg_pool2d_add_nn_relu_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2]);
    }
}
...
extern "C" __global__ void fused_nn_avg_pool2d_add_nn_relu_1_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        fused_nn_avg_pool2d_add_nn_relu_1_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2]);
    }
}
...
extern "C" __global__ void fused_nn_avg_pool2d_add_nn_relu_2_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(392,1,1);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        if (*preempted) return;
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        fused_nn_avg_pool2d_add_nn_relu_2_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2]);
    }
}

extern "C" __global__ void fused_nn_avg_pool2d_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(1,1,1);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        fused_nn_avg_pool2d_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1]);
    }
}
