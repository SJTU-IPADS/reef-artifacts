...
__device__ __noinline__ void fused_nn_conv2d_add_nn_relu_12_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[8];
...
__device__ __noinline__ void fused_nn_conv2d_add_nn_relu_10_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[16];
  __shared__ float pad_temp_shared[1024];
  __shared__ float placeholder_shared[1024];
  compute[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_conv2d_add_nn_relu_9_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[1];
  __shared__ float pad_temp_shared[192];
  __shared__ float placeholder_shared[2304];
  compute[(0)] = 0.000000e+00f;
...
__device__ __noinline__ void fused_nn_conv2d_add_nn_relu_11_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[16];
  __shared__ float pad_temp_shared[1024];
  __shared__ float placeholder_shared[1024];
  compute[(0)] = 0.000000e+00f;
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_nn_relu_12_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_nn_relu_10_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_nn_relu_9_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
...
extern "C" __global__ __attribute__((amdgpu_num_vgpr(24))) __attribute__((amdgpu_num_sgpr(30)))void fused_nn_conv2d_add_nn_relu_11_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
...
extern "C" __global__ void _get_func_pointers(unsigned long long int *address) {
    ...
    address[6] = (unsigned long long int)&fused_nn_conv2d_1_kernel0_device;
    address[7] = (unsigned long long int)&fused_nn_conv2d_2_kernel0_device;
    address[8] = (unsigned long long int)&fused_nn_conv2d_3_kernel0_device;
    address[9] = (unsigned long long int)&fused_nn_conv2d_add_1_kernel0_device;
    address[10] = (unsigned long long int)&fused_nn_conv2d_add_2_kernel0_device;
    address[11] = (unsigned long long int)&fused_nn_conv2d_add_3_kernel0_device;
    address[12] = (unsigned long long int)&fused_nn_conv2d_add_add_nn_relu_1_kernel0_device;
    address[13] = (unsigned long long int)&fused_nn_conv2d_add_add_nn_relu_2_kernel0_device;
    address[14] = (unsigned long long int)&fused_nn_conv2d_add_add_nn_relu_kernel0_device;
    address[15] = (unsigned long long int)&fused_nn_conv2d_add_kernel0_device;
    address[16] = (unsigned long long int)&fused_nn_conv2d_add_multiply_add_nn_relu_kernel0_device;
    address[17] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_10_kernel0_device;
    address[18] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_11_kernel0_device;
    address[19] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_12_kernel0_device;
    address[20] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_1_kernel0_device;
    address[21] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_2_kernel0_device;
    address[22] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_3_kernel0_device;
    address[23] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_4_kernel0_device;
    address[24] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_5_kernel0_device;
    address[25] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_6_kernel0_device;
    address[26] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_7_kernel0_device;
    address[27] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_8_kernel0_device;
    address[28] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_9_kernel0_device;
    address[29] = (unsigned long long int)&fused_nn_conv2d_add_nn_relu_kernel0_device;
    address[30] = (unsigned long long int)&fused_nn_conv2d_kernel0_device;
    address[31] = (unsigned long long int)&fused_nn_dense_add_kernel0_device;
    address[32] = (unsigned long long int)&fused_nn_global_avg_pool2d_kernel0_device;
    address[33] = (unsigned long long int)&fused_nn_max_pool2d_add_nn_relu_kernel0_device;
    address[34] = (unsigned long long int)&fused_nn_softmax_kernel0_device;
