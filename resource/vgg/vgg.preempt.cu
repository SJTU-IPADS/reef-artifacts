...
__device__  void tvmgen_default_fused_nn_conv2d_add_add_nn_relu_2_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3){
  float compute[16];
...
__device__  void tvmgen_default_fused_nn_conv2d_add_add_nn_relu_1_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3){
  float compute[1];
...
__device__  void tvmgen_default_fused_add_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__  void tvmgen_default_fused_nn_conv2d_add_nn_relu_4_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[4];
...
__device__  void tvmgen_default_fused_nn_conv2d_add_nn_relu_9_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[1];
...
__device__  void tvmgen_default_fused_nn_conv2d_1_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
  ...
  for (int rc_outer = 0; rc_outer < 2; ++rc_outer) {
    ...
    for (int ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1 = 0; ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1 < 8; ++ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1) {
      placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1))] = placeholder1[(((((((((int)task_idx.z) * 4096) + (((int)threadIdx.z) * 256)) + (rc_outer * 128)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1))];
    }
    __syncthreads();
...
__device__  void tvmgen_default_fused_nn_conv2d_add_nn_relu_5_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[4];
...
__device__  void tvmgen_default_fused_add_nn_relu_3_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__  void tvmgen_default_fused_nn_conv2d_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
...
__device__  void tvmgen_default_fused_nn_max_pool2d_add_nn_relu_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1){
  float tensor[1];
  tensor[(0)] = -3.402823e+38f;
  for (int rv0 = 0; rv0 < 3; ++rv0) {
    for (int rv1 = 0; rv1 < 3; ++rv1) {
      tensor[(0)] = max(tensor[(0)], (((1 <= (((((int)threadIdx.x) >> 4) * 2) + rv0)) && (1 <= (((((int)threadIdx.x) & 15) * 2) + rv1))) ? placeholder[(((((((((int)task_idx.x) * 1024) + ((((int)threadIdx.x) >> 4) * 64)) + (rv0 * 32)) + ((((int)threadIdx.x) & 15) * 2)) + rv1) - 33))] : -3.402823e+38f));
    }
  }
  T_relu[(((((int)task_idx.x) * 256) + ((int)threadIdx.x)))] = max((tensor[(0)] + placeholder1[(((int)task_idx.x))]), 0.000000e+00f);
}

__device__  void tvmgen_default_fused_nn_conv2d_add_nn_relu_1_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[2];
...
__device__  void tvmgen_default_fused_add_nn_relu_1_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__  void tvmgen_default_fused_nn_dense_add_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  float T_matmul_NT_rf[1];
  float red_buf0[1];
  __shared__ float T_matmul_NT[1];
  T_matmul_NT_rf[(0)] = 0.000000e+00f;
  for (int k_outer = 0; k_outer < 32; ++k_outer) {
    T_matmul_NT_rf[(0)] = __ocml_fma_f32(placeholder[(((k_outer * 64) + ((int)threadIdx.x)))], placeholder1[((((((int)task_idx.x) * 2048) + (k_outer * 64)) + ((int)threadIdx.x)))], T_matmul_NT_rf[(0)]);
  }
  uint mask[1];
  float t0[1];
  ...
  if (((int)threadIdx.x) == 0) {
    T_add[(((int)task_idx.x))] = (T_matmul_NT[(0)] + placeholder2[(((int)task_idx.x))]);
  }
}

__device__  void tvmgen_default_fused_nn_conv2d_add_nn_relu_12_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[8];
...
__device__  void tvmgen_default_fused_nn_softmax_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ T_softmax_norm){
...
__device__  void tvmgen_default_fused_add_nn_relu_2_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__  void tvmgen_default_fused_nn_conv2d_add_add_nn_relu_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3){
  float compute[1];
  __shared__ float pad_temp_shared[64];
  __shared__ float placeholder_shared[1024];
  compute[(0)] = 0.000000e+00f;
  for (int rc_outer = 0; rc_outer < 16; ++rc_outer) {
    ...
    if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
      if (((int)threadIdx.x) < 1) {
        pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((rc_outer * 256) + (((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16)) + (((int)task_idx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)))];
      }
    }
    for (int ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner = 0; ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner < 4; ++ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) {
      placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner))] = placeholder1[((((((((int)task_idx.z) * 16384) + (((int)threadIdx.z) * 256)) + (rc_outer * 16)) + (((int)threadIdx.x) * 4)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner))];
    }
    __syncthreads();
...
__device__  void tvmgen_default_fused_nn_conv2d_add_nn_relu_7_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[1];
  __shared__ float pad_temp_shared[2048];
  __shared__ float placeholder_shared[2048];
  compute[(0)] = 0.000000e+00f;
  for (int rc_outer = 0; rc_outer < 4; ++rc_outer) {
    ...
    for (int ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner = 0; ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner < 8; ++ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner) {
      pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner))] = placeholder[(((((((((rc_outer * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + (ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner >> 2)) >> 2) * 64)) + (((int)task_idx.y) * 32)) + ((((((int)threadIdx.x) * 2) + (ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner >> 2)) & 3) * 8)) + (((int)task_idx.x) * 4)) + (ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner & 3)))];
    }
    for (int ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1 = 0; ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1 < 8; ++ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1) {
      placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1))] = placeholder1[(((((((((int)task_idx.z) * 8192) + (((int)threadIdx.z) * 512)) + (rc_outer * 128)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + ax0_ax1_fused_ax2_fused_ax3_fused_inner_inner_inner1))];
    }
    __syncthreads();
    for (int rc_inner = 0; rc_inner < 128; ++rc_inner) {
...
__device__  void tvmgen_default_fused_nn_conv2d_3_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
...
__device__  void tvmgen_default_fused_nn_conv2d_add_nn_relu_2_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[2];
  __shared__ float pad_temp_shared[144];
  __shared__ float placeholder_shared[256];
  compute[(0)] = 0.000000e+00f;
...
__device__  void tvmgen_default_fused_nn_conv2d_add_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  float compute[2];
...
__device__  void tvmgen_default_fused_nn_conv2d_add_nn_relu_8_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[1];
  __shared__ float pad_temp_shared[6272];
  __shared__ float placeholder_shared[2048];
  compute[(0)] = 0.000000e+00f;
...
__device__  void tvmgen_default_fused_nn_conv2d_add_nn_relu_11_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[16];
  __shared__ float pad_temp_shared[1024];
  __shared__ float placeholder_shared[1024];
  compute[(0)] = 0.000000e+00f;
...
__device__  void tvmgen_default_fused_nn_conv2d_add_nn_relu_3_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[4];
...
__device__  void tvmgen_default_fused_nn_conv2d_add_nn_relu_10_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[16];
  __shared__ float pad_temp_shared[1024];
  __shared__ float placeholder_shared[1024];
  compute[(0)] = 0.000000e+00f;
...
__device__  void tvmgen_default_fused_nn_conv2d_2_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
...
__device__  void tvmgen_default_fused_add_nn_relu_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__  void tvmgen_default_fused_nn_conv2d_add_3_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  float compute[16];
  __shared__ float pad_temp_shared[1024];
  __shared__ float placeholder_shared[1024];
  compute[(0)] = 0.000000e+00f;
...
__device__  void tvmgen_default_fused_nn_conv2d_add_2_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  float compute[1];
  __shared__ float pad_temp_shared[2048];
  __shared__ float placeholder_shared[2048];
  compute[(0)] = 0.000000e+00f;
...
__device__  void tvmgen_default_fused_nn_conv2d_add_multiply_add_nn_relu_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3, float* __restrict__ placeholder4){
  float compute[2];
  __shared__ float pad_temp_shared[128];
  __shared__ float placeholder_shared[2048];
  for (int xx_init = 0; xx_init < 2; ++xx_init) {
...
__device__  void tvmgen_default_fused_nn_conv2d_add_nn_relu_6_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[1];
  __shared__ float pad_temp_shared[192];
  __shared__ float placeholder_shared[2304];
  compute[(0)] = 0.000000e+00f;
...
__device__  void tvmgen_default_fused_nn_global_avg_pool2d_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ tensor){
  float tensor1[1];
...
__device__  void tvmgen_default_fused_nn_batch_flatten_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ tensor, float* __restrict__ placeholder){
  tensor[(((((int)task_idx.x) * 256) + ((int)threadIdx.x)))] = placeholder[(((((int)task_idx.x) * 256) + ((int)threadIdx.x)))];
}

__device__  void tvmgen_default_fused_nn_conv2d_add_1_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  float compute[1];
  __shared__ float pad_temp_shared[64];
  __shared__ float placeholder_shared[1024];
  compute[(0)] = 0.000000e+00f;
...
__device__  void tvmgen_default_fused_nn_conv2d_add_nn_relu_kernel0_device(dim3 task_idx, dim3 thread_idx, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  float compute[2];
  __shared__ float pad_temp_shared[128];
  __shared__ float placeholder_shared[2304];
  compute[(0)] = 0.000000e+00f;
...
extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_add_nn_relu_2_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        tvmgen_default_fused_nn_conv2d_add_add_nn_relu_2_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3], (float* __restrict__)args[4]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_add_nn_relu_1_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_add_nn_relu_1_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3], (float* __restrict__)args[4]);
    }
}

extern "C" __global__ void tvmgen_default_fused_add_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_add_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_4_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_nn_relu_4_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_9_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_nn_relu_9_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_1_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(2,2,32);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_1_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_5_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(1,1,8);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_nn_relu_5_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_add_nn_relu_3_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_add_nn_relu_3_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(1,4,4);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_max_pool2d_add_nn_relu_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_max_pool2d_add_nn_relu_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_1_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_nn_relu_1_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_add_nn_relu_1_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(64,1,1);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_add_nn_relu_1_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_dense_add_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_dense_add_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_12_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_nn_relu_12_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_softmax_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_softmax_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1]);
    }
}

extern "C" __global__ void tvmgen_default_fused_add_nn_relu_2_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_add_nn_relu_2_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_add_nn_relu_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_add_nn_relu_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3], (float* __restrict__)args[4]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_7_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_nn_relu_7_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_3_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_3_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_2_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(1,1,32);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_nn_relu_2_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(1,1,32);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_8_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(2,2,8);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_nn_relu_8_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_11_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_nn_relu_11_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_3_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(1,1,8);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_nn_relu_3_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_10_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(1,4,1);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_nn_relu_10_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_2_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(1,1,32);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_2_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2]);
    }
}

extern "C" __global__ void tvmgen_default_fused_add_nn_relu_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_add_nn_relu_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_3_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(1,4,4);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_3_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_2_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(2,2,32);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_2_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_multiply_add_nn_relu_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(1,1,32);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_multiply_add_nn_relu_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3], (float* __restrict__)args[4], (float* __restrict__)args[5]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_6_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_nn_relu_6_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_global_avg_pool2d_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(256,1,1);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_global_avg_pool2d_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_batch_flatten_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_batch_flatten_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_1_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    dim3 task_dim = dim3(1,4,16);
    dim3 thread_idx = dim3(threadIdx.x, threadIdx.y, threadIdx.z);
    __shared__ int idx[1];
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_1_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_kernel0(volatile int* preempted, int task_num, int task_offset, int* task_slot, float** args) {
    ...
    while (true) {
        ...
        if (idx[0] >= task_num) return;
        dim3 task_idx = get_3d_idx(idx[0], task_dim);
        tvmgen_default_fused_nn_conv2d_add_nn_relu_kernel0_device(task_idx, thread_idx, (float* __restrict__)args[0], (float* __restrict__)args[1], (float* __restrict__)args[2], (float* __restrict__)args[3]);
    }
}
