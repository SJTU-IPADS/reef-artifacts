...
## Y-axis
set ylabel "Latency ({/Symbol m}s)" font ",22" offset 0,0
set yrange [0:1200]
...
### X-axis
set xlabel "Number of Kernels" font ",22" offset 0,-.0
set xrange [50:500]
set xtics 100, 100, 500
set xtics add (' 50' 50)
...
plot "fig13b.dat" u ($1):($3) t "Wait-based"   w l lt 1 lw 5 lc rgb '#006600', \
     "fig13b.dat" u ($1):($2) t "Reset-based"  w l lt 1 lw 5 lc rgb '#cc0000', \
