...
## Y-axis
set ylabel "Latency (ms)" font ",22" offset -1.8,0
set yrange [0:30] 
set ytics 0,10,30 
...
plot "fig10a.dat" using ($2):xticlabels(1) t "RT-Only"              w histogram lw 2 lc rgb "#32CD32", \
     "fig10a.dat" using ($3):xticlabels(1) t "SEQ (no preemption)"  w histogram lw 2 lc rgb "#006600", \
     "fig10a.dat" using ($4):xticlabels(1) t "GPUStreams"           w histogram lw 2 lc rgb "#ff9900", \
     "fig10a.dat" using ($5):xticlabels(1) t "REEF"                 w histogram lw 2 lc rgb "#cc0000",
